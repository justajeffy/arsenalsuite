CREATE OR REPLACE VIEW HostInterfacesVerbose AS
...
CREATE OR REPLACE VIEW StatsByType AS
...
CREATE OR REPLACE VIEW project_slots_current AS
...
CREATE OR REPLACE VIEW project_slots_limits AS
...
CREATE OR REPLACE VIEW running_shots_averagetime AS
...
CREATE OR REPLACE VIEW running_shots_averagetime_2 AS
...
CREATE OR REPLACE VIEW running_shots_averagetime_3 AS
...
CREATE OR REPLACE VIEW running_shots_averagetime_4 AS
...
CREATE OR REPLACE VIEW user_service_limits AS
...
CREATE OR REPLACE VIEW user_slots_current AS
...
CREATE OR REPLACE VIEW user_slots_limits AS

...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	if opt_generate_code:
		ret = os.system(" ".join([config.sip_bin, "-c", "sipStonegui", "-b", "sipStonegui/" + build_file, "-I", config.pyqt_sip_dir, "-I", config.default_sip_dir, config.pyqt_sip_flags, "sip/stonegui.sip"]))
		if ret:
			sys.exit(ret%255)

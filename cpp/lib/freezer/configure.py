...
class AssfreezerModuleMakefile(pyqtconfig.QtCoreModuleMakefile):
...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	if opt_generate_code:
		ret = os.system(" ".join([config.sip_bin, "-c", "sipAssfreezer", "-b", "sipAssfreezer/" + build_file, "-I", config.pyqt_sip_dir, "-I", config.default_sip_dir, config.pyqt_sip_flags, "sip/freezer.sip"]))
		if ret:
			sys.exit(ret%255)
	...
	makefile = AssfreezerModuleMakefile(
	...
	if sys.platform == "win32":
		makefile.extra_libs = ["assfreezer","classes","stone","QtSql4","QtXml4","QtNetwork4","absubmit","Mpr"]
	elif sys.platform == "darwin":
		makefile.extra_libs = ["assfreezer","classes","stone","absubmit"]
	else:
		makefile.extra_libs = ["assfreezer","classes","stone","QtSql","QtXml","QtNetwork","absubmit"]

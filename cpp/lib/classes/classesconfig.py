...
# These are installation specific values created when pyclasses was configured.
...
class ClassesModuleMakefile(pyqtconfig.QtModuleMakefile):
	...
	def finalise(self):
		...
		self.extra_libs.append("classes")

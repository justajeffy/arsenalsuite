...
#	qt_sip_flags = config.pyqt_qt_sip_flags
	...
	if opt_generate_code:
		ret = os.system(" ".join([config.sip_bin, "-c", "sipClasses", "-b", "sipClasses/" + build_file, "-I", config.pyqt_sip_dir, "-I", config.default_sip_dir, config.pyqt_sip_flags, "sip/classes.sip"]))
		if ret:
			sys.exit(ret%255)

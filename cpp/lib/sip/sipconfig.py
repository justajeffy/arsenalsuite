...
_pkg_config = {
    ...
    'default_mod_dir':  '/usr/lib/python2.5/site-packages',
    'default_sip_dir':  '/usr/share/sip',
    'platform':         'linux-g++-64',
    'py_conf_inc_dir':  '/usr/include/python2.5',
    'py_inc_dir':       '/usr/include/python2.5',
    'py_lib_dir':       '/usr/lib/python2.5/config',
    'py_version':       0x020502,
    'sip_bin':          '/usr/bin/sip',
    'sip_config_args':  '-k -p linux-g++-64',
    'sip_inc_dir':      '/usr/include/python2.5',
    'sip_mod_dir':      '/usr/lib/python2.5/site-packages',

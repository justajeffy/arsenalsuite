...
static PyObject *meth_QByteArrayMatcher_setPattern(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QByteArrayMatcher,&sipCpp,sipType_QByteArray,&a0,&a0State))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QByteArrayMatcher,sipName_setPattern);

    return NULL;
}


extern "C" {static PyObject *meth_QByteArrayMatcher_indexIn(PyObject *, PyObject *);}
static PyObject *meth_QByteArrayMatcher_indexIn(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1|i",&sipSelf,sipType_QByteArrayMatcher,&sipCpp,sipType_QByteArray,&a0,&a0State,&a1))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QByteArrayMatcher,sipName_indexIn);
...
static PyObject *meth_QByteArrayMatcher_pattern(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QByteArrayMatcher,&sipCpp))
        {
            QByteArray *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QByteArrayMatcher,sipName_pattern);
...
static void dealloc_QByteArrayMatcher(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QByteArrayMatcher(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QByteArrayMatcher(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QByteArrayMatcher(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QByteArrayMatcher,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QByteArrayMatcher(*a0);
            Py_END_ALLOW_THREADS
...
static PyMethodDef methods_QByteArrayMatcher[] = {
    {SIP_MLNAME_CAST(sipName_indexIn), meth_QByteArrayMatcher_indexIn, METH_VARARGS, NULL},

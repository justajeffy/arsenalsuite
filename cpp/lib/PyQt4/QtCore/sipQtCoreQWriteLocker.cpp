...
#line 104 "sip/QtCore/qreadwritelock.sip"
...
static PyObject *meth_QWriteLocker_unlock(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QWriteLocker,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QWriteLocker,sipName_unlock);
...
static PyObject *meth_QWriteLocker_relock(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWriteLocker,sipName_relock);
...
static PyObject *meth_QWriteLocker_readWriteLock(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWriteLocker,sipName_readWriteLock);
...
#line 115 "sip/QtCore/qreadwritelock.sip"
...
#line 141 "sipQtCoreQWriteLocker.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWriteLocker,sipName___enter__);
...
static PyObject *meth_QWriteLocker___exit__(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BP0P0P0",&sipSelf,sipType_QWriteLocker,&sipCpp,&a0,&a1,&a2))
        {
#line 122 "sip/QtCore/qreadwritelock.sip"
        sipCpp->unlock();
#line 169 "sipQtCoreQWriteLocker.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWriteLocker,sipName___exit__);
...
extern "C" {static void *init_QWriteLocker(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWriteLocker(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static PyMethodDef methods_QWriteLocker[] = {
    ...
    {SIP_MLNAME_CAST(sipName___exit__), meth_QWriteLocker___exit__, METH_VARARGS, NULL},

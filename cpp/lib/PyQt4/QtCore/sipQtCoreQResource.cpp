...
#line 39 "sip/QtCore/qresource.sip"
#include <qresource.h>
...
static PyObject *meth_QResource_absoluteFilePath(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QResource,&sipCpp))
        {
            QString *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_absoluteFilePath);
...
static PyObject *meth_QResource_data(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_data);
...
static PyObject *meth_QResource_fileName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_fileName);
...
static PyObject *meth_QResource_isCompressed(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_isCompressed);
...
static PyObject *meth_QResource_isValid(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_isValid);
...
static PyObject *meth_QResource_locale(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_locale);
...
static PyObject *meth_QResource_setFileName(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QResource,&sipCpp,sipType_QString,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_setFileName);
...
static PyObject *meth_QResource_setLocale(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QResource,&sipCpp,sipType_QLocale,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setLocale(*a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_setLocale);
...
static PyObject *meth_QResource_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_size);
...
static PyObject *meth_QResource_addSearchPath(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_addSearchPath);
...
static PyObject *meth_QResource_registerResource(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_registerResource);
...
static PyObject *meth_QResource_registerResourceData(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"s|J1",&a0,sipType_QString,&a1,&a1State))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_registerResourceData);
...
static PyObject *meth_QResource_searchPaths(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_searchPaths);
...
static PyObject *meth_QResource_unregisterResource(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_unregisterResource);
...
static PyObject *meth_QResource_unregisterResourceData(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_unregisterResourceData);
...
static PyObject *meth_QResource_children(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"p",&sipSelf,sipType_QResource,&sipCpp))
        {
            QStringList *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_children);
...
static PyObject *meth_QResource_isDir(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_isDir);
...
static PyObject *meth_QResource_isFile(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QResource,sipName_isFile);
...
extern "C" {static void *init_QResource(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QResource(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"|J1J9",sipType_QString,&a0,&a0State,sipType_QLocale,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_QResource[] = {
    ...
    {SIP_MLNAME_CAST(sipName_registerResource), meth_QResource_registerResource, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_registerResourceData), meth_QResource_registerResourceData, METH_VARARGS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_unregisterResource), meth_QResource_unregisterResource, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_unregisterResourceData), meth_QResource_unregisterResourceData, METH_VARARGS, NULL}
};

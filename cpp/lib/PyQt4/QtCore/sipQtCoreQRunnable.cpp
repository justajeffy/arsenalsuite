...
static PyObject *meth_QRunnable_run(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QRunnable,&sipCpp))
        {
            if (!sipOrigSelf)
            {
    ...
    sipNoMethod(sipArgsParsed,sipName_QRunnable,sipName_run);
...
static PyObject *meth_QRunnable_autoDelete(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QRunnable,sipName_autoDelete);
...
static PyObject *meth_QRunnable_setAutoDelete(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bb",&sipSelf,sipType_QRunnable,&sipCpp,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QRunnable,sipName_setAutoDelete);
...
static void dealloc_QRunnable(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQRunnable *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QRunnable(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QRunnable(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QRunnable(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QRunnable,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

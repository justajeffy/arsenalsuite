...
QString sipQXmlStreamEntityResolver::resolveUndeclaredEntity(const QString& a0)
{
    ...
    extern QString sipVH_QtCore_0(sip_gilstate_t,PyObject *,bool*,const QString&);

    return sipVH_QtCore_0(sipGILState,meth,0,a0);
}
...
static PyObject *meth_QXmlStreamEntityResolver_resolveUndeclaredEntity(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QXmlStreamEntityResolver,&sipCpp,sipType_QString,&a0,&a0State))
        {
            QString *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QXmlStreamEntityResolver,sipName_resolveUndeclaredEntity);
...
static void dealloc_QXmlStreamEntityResolver(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQXmlStreamEntityResolver *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QXmlStreamEntityResolver(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QXmlStreamEntityResolver(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QXmlStreamEntityResolver(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QXmlStreamEntityResolver,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

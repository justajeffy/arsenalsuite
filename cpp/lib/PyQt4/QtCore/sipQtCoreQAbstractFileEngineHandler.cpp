...
#line 289 "sip/QtCore/qabstractfileengine.sip"
...
QAbstractFileEngine * sipQAbstractFileEngineHandler::create(const QString& a0) const
{
    ...
    extern QAbstractFileEngine * sipVH_QtCore_58(sip_gilstate_t,PyObject *,bool*,const QString&);

    return sipVH_QtCore_58(sipGILState,meth,0,a0);
}
...
static PyObject *meth_QAbstractFileEngineHandler_create(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QAbstractFileEngineHandler,&sipCpp,sipType_QString,&a0,&a0State))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QAbstractFileEngineHandler,sipName_create);
...
static void dealloc_QAbstractFileEngineHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQAbstractFileEngineHandler *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QAbstractFileEngineHandler(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QAbstractFileEngineHandler(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QAbstractFileEngineHandler(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QAbstractFileEngineHandler,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

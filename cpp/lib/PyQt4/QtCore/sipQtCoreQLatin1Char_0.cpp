...
static PyObject *meth_QLatin1Char_0_toLatin1(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QLatin1Char,&sipCpp))
        {
            char sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QLatin1Char,sipName_toLatin1);
...
static PyObject *meth_QLatin1Char_0_unicode(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QLatin1Char,sipName_unicode);

    return NULL;
}


extern "C" {static PyObject *slot_QLatin1Char_0___repr__(PyObject *sipSelf);}
...
static void dealloc_QLatin1Char_0(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QLatin1Char_0(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QLatin1Char_0(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QLatin1Char_0(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{

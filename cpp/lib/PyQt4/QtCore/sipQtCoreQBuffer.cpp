...
#line 37 "sip/QtCore/qbuffer.sip"
#include <qbuffer.h>
...
static PyObject *meth_QBuffer_receivers(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pG",&sipSelf,sipType_QBuffer,&sipCpp,&a0))
        {
            int sipRes = 0;
...
#line 630 "sipQtCoreQBuffer.cpp"
    ...
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_receivers);
...
static PyObject *meth_QBuffer_timerEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pJ8",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QTimerEvent,&a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_timerEvent);
...
static PyObject *meth_QBuffer_childEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pJ8",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QChildEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_childEvent);
...
static PyObject *meth_QBuffer_customEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pJ8",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_customEvent);

    return NULL;
}


extern "C" {static PyObject *meth_QBuffer_readLineData(PyObject *, PyObject *);}
static PyObject *meth_QBuffer_readLineData(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pn",&sipSelf,sipType_QBuffer,&sipCpp,&a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
...
#line 773 "sipQtCoreQBuffer.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_readLineData);
...
static PyObject *meth_QBuffer_setOpenMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pJ1",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QIODevice_OpenMode,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_setOpenMode);
...
static PyObject *meth_QBuffer_setErrorString(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pJ1",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QString,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_setErrorString);
...
static PyObject *meth_QBuffer_buffer(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QBuffer,&sipCpp))
        {
            QByteArray *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_buffer);
...
static PyObject *meth_QBuffer_data(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_data);
...
static PyObject *meth_QBuffer_setBuffer(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ0",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QByteArray,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setBuffer(a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_setBuffer);
...
static PyObject *meth_QBuffer_setData(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QByteArray,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setData(*a0);
            Py_END_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bk",&sipSelf,sipType_QBuffer,&sipCpp,&a0,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_setData);
...
static PyObject *meth_QBuffer_open(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QBuffer,&sipCpp,sipType_QIODevice_OpenMode,&a0,&a0State))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_open);
...
static PyObject *meth_QBuffer_close(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_close);
...
static PyObject *meth_QBuffer_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_size);
...
static PyObject *meth_QBuffer_pos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_pos);
...
static PyObject *meth_QBuffer_seek(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bn",&sipSelf,sipType_QBuffer,&sipCpp,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_seek);
...
static PyObject *meth_QBuffer_atEnd(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_atEnd);
...
static PyObject *meth_QBuffer_canReadLine(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_canReadLine);
...
#line 60 "sip/QtCore/qbuffer.sip"
        // Return the data read or None if there was an error.
        if (a0 < 0)
        {
            PyErr_SetString(PyExc_ValueError, "maximum length of data to be read cannot be negative");
...
#line 1225 "sipQtCoreQBuffer.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_readData);
...
static PyObject *meth_QBuffer_writeData(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pk",&sipSelf,sipType_QBuffer,&sipCpp,&a0,&a1))
        {
            qint64 sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_writeData);
...
static PyObject *meth_QBuffer_connectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_connectNotify);
...
static PyObject *meth_QBuffer_disconnectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBuffer,sipName_disconnectNotify);
...
static void dealloc_QBuffer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQBuffer *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QBuffer(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QBuffer(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QBuffer(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **sipOwner, int *sipArgsParsed)
{
    sipQBuffer *sipCpp = 0;
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J0|JH",sipType_QByteArray,&a0,&a0State,sipType_QObject,&a1,sipOwner))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QBuffer[] = {{62, 255, 1}};
...
static PyMethodDef methods_QBuffer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_readData), meth_QBuffer_readData, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_readLineData), meth_QBuffer_readLineData, METH_VARARGS, NULL},

...
static PyObject *meth_QChildEvent_child(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QChildEvent,&sipCpp))
        {
            QObject *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QChildEvent,sipName_child);
...
static PyObject *meth_QChildEvent_added(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QChildEvent,sipName_added);
...
static PyObject *meth_QChildEvent_polished(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QChildEvent,sipName_polished);
...
static PyObject *meth_QChildEvent_removed(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QChildEvent,sipName_removed);
...
extern "C" {static void *init_QChildEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QChildEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ8",sipType_QEvent_Type,&a0,sipType_QObject,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QChildEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

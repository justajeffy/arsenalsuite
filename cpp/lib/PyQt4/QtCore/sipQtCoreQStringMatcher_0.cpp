...
static PyObject *meth_QStringMatcher_0_setPattern(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QStringMatcher,&sipCpp,sipType_QString,&a0,&a0State))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QStringMatcher,sipName_setPattern);
...
static PyObject *meth_QStringMatcher_0_setCaseSensitivity(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QStringMatcher,&sipCpp,sipType_Qt_CaseSensitivity,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QStringMatcher,sipName_setCaseSensitivity);

    return NULL;
}


extern "C" {static PyObject *meth_QStringMatcher_0_indexIn(PyObject *, PyObject *);}
static PyObject *meth_QStringMatcher_0_indexIn(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1|i",&sipSelf,sipType_QStringMatcher,&sipCpp,sipType_QString,&a0,&a0State,&a1))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QStringMatcher,sipName_indexIn);
...
static PyObject *meth_QStringMatcher_0_pattern(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QStringMatcher,&sipCpp))
        {
            QString *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QStringMatcher,sipName_pattern);
...
static PyObject *meth_QStringMatcher_0_caseSensitivity(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QStringMatcher,sipName_caseSensitivity);
...
extern "C" {static void *init_QStringMatcher_0(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStringMatcher_0(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1|E",sipType_QString,&a0,&a0State,sipType_Qt_CaseSensitivity,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStringMatcher,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_QStringMatcher_0[] = {
    ...
    {SIP_MLNAME_CAST(sipName_indexIn), meth_QStringMatcher_0_indexIn, METH_VARARGS, NULL},

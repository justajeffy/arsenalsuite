...
static PyObject *meth_QBasicTimer_isActive(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QBasicTimer,&sipCpp))
        {
            bool sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QBasicTimer,sipName_isActive);
...
static PyObject *meth_QBasicTimer_timerId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBasicTimer,sipName_timerId);
...
static PyObject *meth_QBasicTimer_start(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BiJ8",&sipSelf,sipType_QBasicTimer,&sipCpp,&a0,sipType_QObject,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->start(a0,a1);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBasicTimer,sipName_start);
...
static PyObject *meth_QBasicTimer_stop(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBasicTimer,sipName_stop);
...
static void dealloc_QBasicTimer(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QBasicTimer(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QBasicTimer(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QBasicTimer(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QBasicTimer,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

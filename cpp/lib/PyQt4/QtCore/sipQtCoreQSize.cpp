...
static PyObject *meth_QSize_transpose(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QSize,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_transpose);
...
static PyObject *meth_QSize_scale(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9E",&sipSelf,sipType_QSize,&sipCpp,sipType_QSize,&a0,sipType_Qt_AspectRatioMode,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->scale(*a0,a1);
            Py_END_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BiiE",&sipSelf,sipType_QSize,&sipCpp,&a0,&a1,sipType_Qt_AspectRatioMode,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_scale);
...
static PyObject *meth_QSize_isNull(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_isNull);
...
static PyObject *meth_QSize_isEmpty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_isEmpty);
...
static PyObject *meth_QSize_isValid(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_isValid);
...
static PyObject *meth_QSize_width(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_width);
...
static PyObject *meth_QSize_height(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_height);
...
static PyObject *meth_QSize_setWidth(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bi",&sipSelf,sipType_QSize,&sipCpp,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setWidth(a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_setWidth);
...
static PyObject *meth_QSize_setHeight(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_setHeight);
...
static PyObject *meth_QSize_expandedTo(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QSize,&sipCpp,sipType_QSize,&a0))
        {
            QSize *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_expandedTo);
...
static PyObject *meth_QSize_boundedTo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSize,sipName_boundedTo);
...
static PyObject *slot_QSize___eq__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QSize,&a0))
        {
            bool sipRes;
...
static PyObject *slot_QSize___add__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J9J9",sipType_QSize,&a0,sipType_QSize,&a1))
        {
            QSize *sipRes;
...
static PyObject *slot_QSize___mul__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"dJ9",&a0,sipType_QSize,&a1))
        {
            QSize *sipRes;
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J9d",sipType_QSize,&a0,&a1))
        {
            QSize *sipRes;
...
extern "C" {static int slot_QSize___bool__(PyObject *sipSelf);}
...
#line 70 "sip/QtCore/qsize.sip"
        sipRes = sipCpp->isValid();
#line 699 "sipQtCoreQSize.cpp"
...
#line 45 "sip/QtCore/qsize.sip"
    sipRes = Py_BuildValue((char *)"ii", sipCpp->width(), sipCpp->height());
#line 768 "sipQtCoreQSize.cpp"
...
extern "C" {static void *init_QSize(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QSize(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    QSize *sipCpp = 0;

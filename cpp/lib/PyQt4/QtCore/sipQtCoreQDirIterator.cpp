...
static PyObject *meth_QDirIterator_next(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDirIterator,&sipCpp))
        {
            QString *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_next);
...
static PyObject *meth_QDirIterator_hasNext(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_hasNext);
...
static PyObject *meth_QDirIterator_fileName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_fileName);
...
static PyObject *meth_QDirIterator_filePath(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_filePath);
...
static PyObject *meth_QDirIterator_fileInfo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_fileInfo);
...
static PyObject *meth_QDirIterator_path(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDirIterator,sipName_path);
...
static void dealloc_QDirIterator(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQDirIterator *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QDirIterator(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QDirIterator(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDirIterator(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9|J1",sipType_QDir,&a0,sipType_QDirIterator_IteratorFlags,&a1,&a1State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1|J1",sipType_QString,&a0,&a0State,sipType_QDirIterator_IteratorFlags,&a1,&a1State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new sipQDirIterator(*a0,*a1);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1J1|J1",sipType_QString,&a0,&a0State,sipType_QDir_Filters,&a1,&a1State,sipType_QDirIterator_IteratorFlags,&a2,&a2State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1J1|J1J1",sipType_QString,&a0,&a0State,sipType_QStringList,&a1,&a1State,sipType_QDir_Filters,&a2,&a2State,sipType_QDirIterator_IteratorFlags,&a3,&a3State))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QDirIterator[] = {
    {sipName_FollowSymlinks, QDirIterator::FollowSymlinks, 43},
    {sipName_NoIteratorFlags, QDirIterator::NoIteratorFlags, 43},
    {sipName_Subdirectories, QDirIterator::Subdirectories, 43},
};

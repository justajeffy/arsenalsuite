...
static PyObject *meth_QMutex_lock(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QMutex,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QMutex,sipName_lock);
...
static PyObject *meth_QMutex_tryLock(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bi",&sipSelf,sipType_QMutex,&sipCpp,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMutex,sipName_tryLock);
...
static PyObject *meth_QMutex_unlock(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMutex,sipName_unlock);
...
extern "C" {static void *init_QMutex(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QMutex(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    QMutex *sipCpp = 0;
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"|E",sipType_QMutex_RecursionMode,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QMutex[] = {
    {sipName_NonRecursive, QMutex::NonRecursive, 109},
    {sipName_Recursive, QMutex::Recursive, 109},
};

...
static PyObject *meth_QXmlStreamNamespaceDeclaration_prefix(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QXmlStreamNamespaceDeclaration,&sipCpp))
        {
            QStringRef *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QXmlStreamNamespaceDeclaration,sipName_prefix);
...
static PyObject *meth_QXmlStreamNamespaceDeclaration_namespaceUri(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QXmlStreamNamespaceDeclaration,sipName_namespaceUri);

    return NULL;
}


extern "C" {static PyObject *slot_QXmlStreamNamespaceDeclaration___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QXmlStreamNamespaceDeclaration___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QXmlStreamNamespaceDeclaration,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QXmlStreamNamespaceDeclaration___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QXmlStreamNamespaceDeclaration(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QXmlStreamNamespaceDeclaration(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QXmlStreamNamespaceDeclaration(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QXmlStreamNamespaceDeclaration(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QXmlStreamNamespaceDeclaration,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

...
QScriptClass::QueryFlags sipQScriptClass::queryProperty(const QScriptValue& a0,const QScriptString& a1,QScriptClass::QueryFlags a2,uint *a3)
{
    ...
    extern QScriptClass::QueryFlags sipVH_QtScript_17(sip_gilstate_t,PyObject *,bool*,const QScriptValue&,const QScriptString&,QScriptClass::QueryFlags,unsigned *);

    return sipVH_QtScript_17(sipGILState,meth,0,a0,a1,a2,a3);
}
...
QScriptValue sipQScriptClass::property(const QScriptValue& a0,const QScriptString& a1,uint a2)
{
    ...
    extern QScriptValue sipVH_QtScript_16(sip_gilstate_t,PyObject *,bool*,const QScriptValue&,const QScriptString&,unsigned);

    return sipVH_QtScript_16(sipGILState,meth,0,a0,a1,a2);
}
...
void sipQScriptClass::setProperty(QScriptValue& a0,const QScriptString& a1,uint a2,const QScriptValue& a3)
{
    ...
    extern void sipVH_QtScript_15(sip_gilstate_t,PyObject *,bool*,QScriptValue&,const QScriptString&,unsigned,const QScriptValue&);

    sipVH_QtScript_15(sipGILState,meth,0,a0,a1,a2,a3);
}
...
QScriptValue::PropertyFlags sipQScriptClass::propertyFlags(const QScriptValue& a0,const QScriptString& a1,uint a2)
{
    ...
    extern QScriptValue::PropertyFlags sipVH_QtScript_14(sip_gilstate_t,PyObject *,bool*,const QScriptValue&,const QScriptString&,unsigned);

    return sipVH_QtScript_14(sipGILState,meth,0,a0,a1,a2);
}
...
QScriptClassPropertyIterator * sipQScriptClass::newIterator(const QScriptValue& a0)
{
    ...
    extern QScriptClassPropertyIterator * sipVH_QtScript_13(sip_gilstate_t,PyObject *,bool*,const QScriptValue&);

    return sipVH_QtScript_13(sipGILState,meth,0,a0);
}
...
QScriptValue sipQScriptClass::prototype() const
{
    ...
    extern QScriptValue sipVH_QtScript_12(sip_gilstate_t,PyObject *,bool*);

    return sipVH_QtScript_12(sipGILState,meth,0);
}
...
QString sipQScriptClass::name() const
{
    ...
    return ((sipVH_QtCore_57)(sipModuleAPI_QtScript_QtCore->em_virthandlers[57]))(sipGILState,meth,0);
}
...
bool sipQScriptClass::supportsExtension(QScriptClass::Extension a0) const
{
    ...
    extern bool sipVH_QtScript_11(sip_gilstate_t,PyObject *,bool*,QScriptClass::Extension);

    return sipVH_QtScript_11(sipGILState,meth,0,a0);
}
...
QVariant sipQScriptClass::extension(QScriptClass::Extension a0,const QVariant& a1)
{
    ...
    extern QVariant sipVH_QtScript_10(sip_gilstate_t,PyObject *,bool*,QScriptClass::Extension,const QVariant&);

    return sipVH_QtScript_10(sipGILState,meth,0,a0,a1);
}
...
static PyObject *meth_QScriptClass_engine(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QScriptClass,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_engine);
...
static PyObject *meth_QScriptClass_queryProperty(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9J9J1",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptValue,&a0,sipType_QScriptString,&a1,sipType_QScriptClass_QueryFlags,&a2,&a2State))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_queryProperty);
...
static PyObject *meth_QScriptClass_property(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9J9u",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptValue,&a0,sipType_QScriptString,&a1,&a2))
        {
            QScriptValue *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_property);
...
static PyObject *meth_QScriptClass_setProperty(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9J9uJ9",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptValue,&a0,sipType_QScriptString,&a1,&a2,sipType_QScriptValue,&a3))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_setProperty);
...
static PyObject *meth_QScriptClass_propertyFlags(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_propertyFlags);
...
static PyObject *meth_QScriptClass_newIterator(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptValue,&a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_newIterator);
...
static PyObject *meth_QScriptClass_prototype(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_prototype);
...
static PyObject *meth_QScriptClass_name(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_name);
...
static PyObject *meth_QScriptClass_supportsExtension(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptClass_Extension,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_supportsExtension);

    return NULL;
}


extern "C" {static PyObject *meth_QScriptClass_extension(PyObject *, PyObject *);}
static PyObject *meth_QScriptClass_extension(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE|J1",&sipSelf,sipType_QScriptClass,&sipCpp,sipType_QScriptClass_Extension,&a0,sipType_QVariant,&a1,&a1State))
        {
            QVariant *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptClass,sipName_extension);
...
static void dealloc_QScriptClass(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQScriptClass *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QScriptClass(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QScriptClass(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QScriptClass(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static PyMethodDef methods_QScriptClass[] = {
    ...
    {SIP_MLNAME_CAST(sipName_extension), meth_QScriptClass_extension, METH_VARARGS, NULL},

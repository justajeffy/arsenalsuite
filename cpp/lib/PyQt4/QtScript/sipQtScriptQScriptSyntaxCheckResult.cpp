...
static PyObject *meth_QScriptSyntaxCheckResult_state(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QScriptSyntaxCheckResult,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QScriptSyntaxCheckResult,sipName_state);
...
static PyObject *meth_QScriptSyntaxCheckResult_errorLineNumber(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptSyntaxCheckResult,sipName_errorLineNumber);
...
static PyObject *meth_QScriptSyntaxCheckResult_errorColumnNumber(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptSyntaxCheckResult,sipName_errorColumnNumber);
...
static PyObject *meth_QScriptSyntaxCheckResult_errorMessage(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QScriptSyntaxCheckResult,sipName_errorMessage);
...
static void dealloc_QScriptSyntaxCheckResult(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QScriptSyntaxCheckResult(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QScriptSyntaxCheckResult(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QScriptSyntaxCheckResult(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QScriptSyntaxCheckResult,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

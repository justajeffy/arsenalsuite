...
static PyObject *slot_QStyleOptionFrameV2_FrameFeatures___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J1",sipType_QStyleOptionFrameV2_FrameFeatures,&a0,&a0State))
        {
            bool sipRes = 0;
...
#line 309 "sip/QtCore/qglobal.sip"
        sipRes = (sipCpp->operator int() == a0->operator int());
#line 121 "sipQtGuiQStyleOptionFrameV2FrameFeatures.cpp"
...
static PyObject *slot_QStyleOptionFrameV2_FrameFeatures___and__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J1i",sipType_QStyleOptionFrameV2_FrameFeatures,&a0,&a0State,&a1))
        {
            QStyleOptionFrameV2::FrameFeatures *sipRes;
...
static PyObject *slot_QStyleOptionFrameV2_FrameFeatures___xor__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J1J1",sipType_QStyleOptionFrameV2_FrameFeatures,&a0,&a0State,sipType_QStyleOptionFrameV2_FrameFeatures,&a1,&a1State))
        {
            QStyleOptionFrameV2::FrameFeatures *sipRes;
...
extern "C" {static void *init_QStyleOptionFrameV2_FrameFeatures(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionFrameV2_FrameFeatures(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1",sipType_QStyleOptionFrameV2_FrameFeatures,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
...
return 0;
#line 506 "sipQtGuiQStyleOptionFrameV2FrameFeatures.cpp"
}

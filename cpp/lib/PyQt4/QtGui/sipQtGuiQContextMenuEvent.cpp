...
static PyObject *meth_QContextMenuEvent_x(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QContextMenuEvent,&sipCpp))
        {
            int sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_x);
...
static PyObject *meth_QContextMenuEvent_y(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_y);
...
static PyObject *meth_QContextMenuEvent_globalX(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_globalX);
...
static PyObject *meth_QContextMenuEvent_globalY(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_globalY);
...
static PyObject *meth_QContextMenuEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_pos);
...
static PyObject *meth_QContextMenuEvent_globalPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_globalPos);
...
static PyObject *meth_QContextMenuEvent_reason(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QContextMenuEvent,sipName_reason);
...
extern "C" {static void *init_QContextMenuEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QContextMenuEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9J9J1",sipType_QContextMenuEvent_Reason,&a0,sipType_QPoint,&a1,sipType_QPoint,&a2,sipType_Qt_KeyboardModifiers,&a3,&a3State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9J9",sipType_QContextMenuEvent_Reason,&a0,sipType_QPoint,&a1,sipType_QPoint,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9",sipType_QContextMenuEvent_Reason,&a0,sipType_QPoint,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QContextMenuEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QContextMenuEvent[] = {{223, 255, 1}};
...
static sipEnumMemberDef enummembers_QContextMenuEvent[] = {
    {sipName_Keyboard, QContextMenuEvent::Keyboard, 69},
    {sipName_Mouse, QContextMenuEvent::Mouse, 69},
    {sipName_Other, QContextMenuEvent::Other, 69},
};

...
static void dealloc_QStyleOptionFrameV3(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionFrameV3(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionFrameV3(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionFrameV3(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionFrameV3,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionFrameV3[] = {{466, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFrameV3[] = {
    {sipName_Version, QStyleOptionFrameV3::Version, 471},
};

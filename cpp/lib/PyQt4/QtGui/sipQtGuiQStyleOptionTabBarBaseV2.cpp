...
static void dealloc_QStyleOptionTabBarBaseV2(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionTabBarBaseV2(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionTabBarBaseV2(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionTabBarBaseV2(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionTabBarBaseV2,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionTabBarBase,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QStyleOptionTabBarBaseV2(*a0);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionTabBarBaseV2[] = {{514, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabBarBaseV2[] = {
    {sipName_Version, QStyleOptionTabBarBaseV2::Version, 518},
};

...
static PyObject *meth_QBitmap_metric(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pE",&sipSelf,sipType_QBitmap,&sipCpp,sipType_QPaintDevice_PaintDeviceMetric,&a0))
        {
            int sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QBitmap,sipName_metric);
...
static PyObject *meth_QBitmap_clear(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QBitmap,&sipCpp))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->clear();
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBitmap,sipName_clear);

    return NULL;
}


extern "C" {static PyObject *meth_QBitmap_fromImage(PyObject *, PyObject *);}
static PyObject *meth_QBitmap_fromImage(PyObject *, PyObject *sipArgs)
{
    int sipArgsParsed = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBitmap,sipName_fromImage);

    return NULL;
}


extern "C" {static PyObject *meth_QBitmap_fromData(PyObject *, PyObject *);}
static PyObject *meth_QBitmap_fromData(PyObject *, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J9s|E",sipType_QSize,&a0,&a1,sipType_QImage_Format,&a2))
        {
            QBitmap *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBitmap,sipName_fromData);
...
static PyObject *meth_QBitmap_transformed(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBitmap,&sipCpp,sipType_QMatrix,&a0))
        {
            QBitmap *sipRes;
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBitmap,&sipCpp,sipType_QTransform,&a0))
        {
            QBitmap *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBitmap,sipName_transformed);
...
extern "C" {static void *init_QBitmap(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QBitmap(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    sipQBitmap *sipCpp = 0;
    ...
    if (!sipCpp)
    {
        ...
        {
#line 52 "sip/QtGui/qbitmap.sip"
        sipCpp = new sipQBitmap(qVariantValue<QBitmap>(*a0));
#line 521 "sipQtGuiQBitmap.cpp"
...
static sipEncodedTypeDef supers_QBitmap[] = {{343, 255, 1}};


static PyMethodDef methods_QBitmap[] = {
    {SIP_MLNAME_CAST(sipName_clear), meth_QBitmap_clear, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_fromData), meth_QBitmap_fromData, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_fromImage), meth_QBitmap_fromImage, METH_VARARGS, NULL},

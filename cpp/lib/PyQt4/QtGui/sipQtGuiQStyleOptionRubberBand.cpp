...
static void dealloc_QStyleOptionRubberBand(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionRubberBand(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionRubberBand(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionRubberBand(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionRubberBand,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionRubberBand[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionRubberBand[] = {
    {sipName_Type, QStyleOptionRubberBand::Type, 496},
    {sipName_Version, QStyleOptionRubberBand::Version, 497},
};

...
static void dealloc_QStyleOptionTabBarBase(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionTabBarBase(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionTabBarBase(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionTabBarBase(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QStyleOptionTabBarBase[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabBarBase[] = {
    {sipName_Type, QStyleOptionTabBarBase::Type, 515},
    {sipName_Version, QStyleOptionTabBarBase::Version, 516},
};

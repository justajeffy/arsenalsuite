...
static PyObject *meth_QClipboard_clear(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B|E",&sipSelf,sipType_QClipboard,&sipCpp,sipType_QClipboard_Mode,&a0))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_clear);
...
static PyObject *meth_QClipboard_supportsFindBuffer(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QClipboard,&sipCpp))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_supportsFindBuffer);
...
static PyObject *meth_QClipboard_supportsSelection(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_supportsSelection);
...
static PyObject *meth_QClipboard_ownsClipboard(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_ownsClipboard);
...
static PyObject *meth_QClipboard_ownsFindBuffer(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_ownsFindBuffer);
...
static PyObject *meth_QClipboard_ownsSelection(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_ownsSelection);
...
static PyObject *meth_QClipboard_text(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    if (sipIsAPIEnabled(sipName_QString, 2, 0))
    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1|E",&sipSelf,sipType_QClipboard,&sipCpp,sipType_QString,&a0,&a0State,sipType_QClipboard_Mode,&a1))
        {
            PyObject * sipRes = 0;

#line 66 "sip/QtGui/qclipboard.sip"
        QString *text;
...
#line 307 "sipQtGuiQClipboard.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_text);
...
static PyObject *meth_QClipboard_setText(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_setText);

    return NULL;
}


extern "C" {static PyObject *meth_QClipboard_mimeData(PyObject *, PyObject *);}
static PyObject *meth_QClipboard_mimeData(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_mimeData);

    return NULL;
}


extern "C" {static PyObject *meth_QClipboard_setMimeData(PyObject *, PyObject *);}
static PyObject *meth_QClipboard_setMimeData(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B@J8|E",&sipSelf,sipType_QClipboard,&sipCpp,&a0Wrapper,sipType_QMimeData,&a0,sipType_QClipboard_Mode,&a1))
        {
#line 94 "sip/QtGui/qclipboard.sip"
        Py_BEGIN_ALLOW_THREADS
...
#line 424 "sipQtGuiQClipboard.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_setMimeData);
...
static PyObject *meth_QClipboard_image(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_image);
...
static PyObject *meth_QClipboard_pixmap(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_pixmap);
...
static PyObject *meth_QClipboard_setImage(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9|E",&sipSelf,sipType_QClipboard,&sipCpp,sipType_QImage,&a0,sipType_QClipboard_Mode,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_setImage);
...
static PyObject *meth_QClipboard_setPixmap(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9|E",&sipSelf,sipType_QClipboard,&sipCpp,sipType_QPixmap,&a0,sipType_QClipboard_Mode,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QClipboard,sipName_setPixmap);
...
static sipEncodedTypeDef supers_QClipboard[] = {{111, 0, 1}};
...
static PyMethodDef methods_QClipboard[] = {
    ...
    {SIP_MLNAME_CAST(sipName_mimeData), meth_QClipboard_mimeData, METH_VARARGS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_setMimeData), meth_QClipboard_setMimeData, METH_VARARGS, NULL},
...
static sipEnumMemberDef enummembers_QClipboard[] = {
    {sipName_Clipboard, QClipboard::Clipboard, 52},
    {sipName_FindBuffer, QClipboard::FindBuffer, 52},
    {sipName_Selection, QClipboard::Selection, 52},
};

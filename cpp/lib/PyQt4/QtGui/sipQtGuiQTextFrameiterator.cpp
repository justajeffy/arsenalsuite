...
static PyObject *meth_QTextFrame_iterator_parentFrame(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QTextFrame_iterator,&sipCpp))
        {
            QTextFrame *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_iterator,sipName_parentFrame);
...
static PyObject *meth_QTextFrame_iterator_currentFrame(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_iterator,sipName_currentFrame);
...
static PyObject *meth_QTextFrame_iterator_currentBlock(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_iterator,sipName_currentBlock);
...
extern "C" {static PyObject *slot_QTextFrame_iterator___isub__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QTextFrame_iterator___isub__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        {
#line 120 "sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)--;
            else if (a0 < 0)
...
extern "C" {static PyObject *slot_QTextFrame_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QTextFrame_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1i",&a0))
        {
#line 110 "sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)++;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)--;
#line 233 "sipQtGuiQTextFrameiterator.cpp"
...
extern "C" {static PyObject *slot_QTextFrame_iterator___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QTextFrame_iterator___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QTextFrame_iterator,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QTextFrame_iterator___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QTextFrame_iterator(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextFrame_iterator(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextFrame_iterator(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextFrame_iterator(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextFrame_iterator,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

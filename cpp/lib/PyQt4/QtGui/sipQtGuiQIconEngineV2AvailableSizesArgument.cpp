...
static void dealloc_QIconEngineV2_AvailableSizesArgument(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QIconEngineV2_AvailableSizesArgument(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QIconEngineV2_AvailableSizesArgument(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QIconEngineV2_AvailableSizesArgument(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QIconEngineV2_AvailableSizesArgument,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

...
static PyObject *meth_QSpacerItem_changeSize(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bii|EE",&sipSelf,sipType_QSpacerItem,&sipCpp,&a0,&a1,sipType_QSizePolicy_Policy,&a2,sipType_QSizePolicy_Policy,&a3))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_changeSize);
...
static PyObject *meth_QSpacerItem_sizeHint(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QSpacerItem,&sipCpp))
        {
            QSize *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_sizeHint);
...
static PyObject *meth_QSpacerItem_minimumSize(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_minimumSize);
...
static PyObject *meth_QSpacerItem_maximumSize(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_maximumSize);
...
static PyObject *meth_QSpacerItem_expandingDirections(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_expandingDirections);
...
static PyObject *meth_QSpacerItem_isEmpty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_isEmpty);
...
static PyObject *meth_QSpacerItem_setGeometry(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QSpacerItem,&sipCpp,sipType_QRect,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_setGeometry);
...
static PyObject *meth_QSpacerItem_geometry(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_geometry);
...
static PyObject *meth_QSpacerItem_spacerItem(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSpacerItem,sipName_spacerItem);
...
extern "C" {static void *init_QSpacerItem(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QSpacerItem(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"ii|EE",&a0,&a1,sipType_QSizePolicy_Policy,&a2,sipType_QSizePolicy_Policy,&a3))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QSpacerItem,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QSpacerItem[] = {{247, 255, 1}};

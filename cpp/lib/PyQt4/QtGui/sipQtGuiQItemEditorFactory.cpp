...
QWidget * sipQItemEditorFactory::createEditor(QVariant::Type a0,QWidget *a1) const
{
    ...
    extern QWidget * sipVH_QtGui_176(sip_gilstate_t,PyObject *,bool*,QVariant::Type,QWidget *);

    return sipVH_QtGui_176(sipGILState,meth,0,a0,a1);
}
...
QByteArray sipQItemEditorFactory::valuePropertyName(QVariant::Type a0) const
{
    ...
    extern QByteArray sipVH_QtGui_175(sip_gilstate_t,PyObject *,bool*,QVariant::Type);

    return sipVH_QtGui_175(sipGILState,meth,0,a0);
}
...
static PyObject *meth_QItemEditorFactory_createEditor(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BEJH",&sipSelf,sipType_QItemEditorFactory,&sipCpp,sipType_QVariant_Type,&a0,sipType_QWidget,&a1,&sipOwner))
        {
            QWidget *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QItemEditorFactory,sipName_createEditor);
...
static PyObject *meth_QItemEditorFactory_valuePropertyName(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QItemEditorFactory,&sipCpp,sipType_QVariant_Type,&a0))
        {
            QByteArray *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QItemEditorFactory,sipName_valuePropertyName);
...
static PyObject *meth_QItemEditorFactory_registerEditor(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BEJ:",&sipSelf,sipType_QItemEditorFactory,&sipCpp,sipType_QVariant_Type,&a0,sipType_QItemEditorCreatorBase,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QItemEditorFactory,sipName_registerEditor);
...
static PyObject *meth_QItemEditorFactory_defaultFactory(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QItemEditorFactory,sipName_defaultFactory);
...
static PyObject *meth_QItemEditorFactory_setDefaultFactory(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J:",sipType_QItemEditorFactory,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QItemEditorFactory,sipName_setDefaultFactory);
...
static void dealloc_QItemEditorFactory(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQItemEditorFactory *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QItemEditorFactory(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QItemEditorFactory(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QItemEditorFactory(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QItemEditorFactory,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

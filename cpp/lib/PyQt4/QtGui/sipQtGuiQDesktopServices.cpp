...
static PyObject *meth_QDesktopServices_openUrl(PyObject *, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipArgsParsed,sipName_QDesktopServices,sipName_openUrl);
...
static PyObject *meth_QDesktopServices_setUrlHandler(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J1J8s",sipType_QString,&a0,&a0State,sipType_QObject,&a1,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J1F",sipType_QString,&a0,&a0State,&a1))
        {
#line 67 "sip/QtGui/qdesktopservices.sip"
...
#line 135 "sipQtGuiQDesktopServices.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDesktopServices,sipName_setUrlHandler);
...
static PyObject *meth_QDesktopServices_unsetUrlHandler(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDesktopServices,sipName_unsetUrlHandler);
...
static PyObject *meth_QDesktopServices_storageLocation(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"E",sipType_QDesktopServices_StandardLocation,&a0))
        {
            QString *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDesktopServices,sipName_storageLocation);
...
static PyObject *meth_QDesktopServices_displayName(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDesktopServices,sipName_displayName);
...
static void dealloc_QDesktopServices(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QDesktopServices(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QDesktopServices(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDesktopServices(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDesktopServices,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_QDesktopServices[] = {
    ...
    {SIP_MLNAME_CAST(sipName_setUrlHandler), meth_QDesktopServices_setUrlHandler, METH_VARARGS, NULL},
...
static sipEnumMemberDef enummembers_QDesktopServices[] = {
    {sipName_ApplicationsLocation, QDesktopServices::ApplicationsLocation, 78},
    {sipName_CacheLocation, QDesktopServices::CacheLocation, 78},
    {sipName_DataLocation, QDesktopServices::DataLocation, 78},
    {sipName_DesktopLocation, QDesktopServices::DesktopLocation, 78},
    {sipName_DocumentsLocation, QDesktopServices::DocumentsLocation, 78},
    {sipName_FontsLocation, QDesktopServices::FontsLocation, 78},
    {sipName_HomeLocation, QDesktopServices::HomeLocation, 78},
    {sipName_MoviesLocation, QDesktopServices::MoviesLocation, 78},
    {sipName_MusicLocation, QDesktopServices::MusicLocation, 78},
    {sipName_PicturesLocation, QDesktopServices::PicturesLocation, 78},
    {sipName_TempLocation, QDesktopServices::TempLocation, 78},
};

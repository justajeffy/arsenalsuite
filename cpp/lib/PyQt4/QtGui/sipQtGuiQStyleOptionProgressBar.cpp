...
static void dealloc_QStyleOptionProgressBar(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionProgressBar(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionProgressBar(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionProgressBar(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QStyleOptionProgressBar[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionProgressBar[] = {
    {sipName_Type, QStyleOptionProgressBar::Type, 490},
    {sipName_Version, QStyleOptionProgressBar::Version, 491},
};

...
static void dealloc_QStyleOptionTabV3(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionTabV3(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionTabV3(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionTabV3(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionTabV3,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionTabV3[] = {{519, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabV3[] = {
    {sipName_Version, QStyleOptionTabV3::Version, 522},
};

...
static void dealloc_QTextEdit_ExtraSelection(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextEdit_ExtraSelection(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextEdit_ExtraSelection(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextEdit_ExtraSelection(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextEdit_ExtraSelection,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

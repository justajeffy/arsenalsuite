...
static void dealloc_QInputMethodEvent_Attribute(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QInputMethodEvent_Attribute(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QInputMethodEvent_Attribute(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QInputMethodEvent_Attribute(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EiiJ1",sipType_QInputMethodEvent_AttributeType,&a0,&a1,&a2,sipType_QVariant,&a3,&a3State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QInputMethodEvent_Attribute,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

...
static PyObject *meth_QGraphicsSceneMoveEvent_oldPos(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QGraphicsSceneMoveEvent,&sipCpp))
        {
            QPointF *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QGraphicsSceneMoveEvent,sipName_oldPos);
...
static PyObject *meth_QGraphicsSceneMoveEvent_newPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGraphicsSceneMoveEvent,sipName_newPos);
...
static void dealloc_QGraphicsSceneMoveEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQGraphicsSceneMoveEvent *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QGraphicsSceneMoveEvent(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QGraphicsSceneMoveEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QGraphicsSceneMoveEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QGraphicsSceneMoveEvent[] = {{173, 255, 1}};

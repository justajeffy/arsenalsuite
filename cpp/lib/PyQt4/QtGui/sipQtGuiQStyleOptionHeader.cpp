...
static void dealloc_QStyleOptionHeader(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionHeader(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionHeader(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionHeader(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionHeader,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionHeader[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionHeader[] = {
    {sipName_Beginning, QStyleOptionHeader::Beginning, 479},
    {sipName_End, QStyleOptionHeader::End, 479},
    {sipName_Middle, QStyleOptionHeader::Middle, 479},
    {sipName_NextAndPreviousAreSelected, QStyleOptionHeader::NextAndPreviousAreSelected, 480},
    {sipName_NextIsSelected, QStyleOptionHeader::NextIsSelected, 480},
    {sipName_None, QStyleOptionHeader::None, 481},
    {sipName_NotAdjacent, QStyleOptionHeader::NotAdjacent, 480},
    {sipName_OnlyOneSection, QStyleOptionHeader::OnlyOneSection, 479},
    {sipName_PreviousIsSelected, QStyleOptionHeader::PreviousIsSelected, 480},
    {sipName_SortDown, QStyleOptionHeader::SortDown, 481},
    {sipName_SortUp, QStyleOptionHeader::SortUp, 481},
    {sipName_Type, QStyleOptionHeader::Type, 482},
    {sipName_Version, QStyleOptionHeader::Version, 483},
};

...
static void dealloc_QStyleOptionTab(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionTab(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionTab(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionTab(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QStyleOptionTab[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTab[] = {
    {sipName_Beginning, QStyleOptionTab::Beginning, 513},
    {sipName_End, QStyleOptionTab::End, 513},
    {sipName_LeftCornerWidget, QStyleOptionTab::LeftCornerWidget, 508},
    {sipName_Middle, QStyleOptionTab::Middle, 513},
    {sipName_NextIsSelected, QStyleOptionTab::NextIsSelected, 510},
    {sipName_NoCornerWidgets, QStyleOptionTab::NoCornerWidgets, 508},
    {sipName_NotAdjacent, QStyleOptionTab::NotAdjacent, 510},
    {sipName_OnlyOneTab, QStyleOptionTab::OnlyOneTab, 513},
    {sipName_PreviousIsSelected, QStyleOptionTab::PreviousIsSelected, 510},
    {sipName_RightCornerWidget, QStyleOptionTab::RightCornerWidget, 508},
    {sipName_Type, QStyleOptionTab::Type, 511},
    {sipName_Version, QStyleOptionTab::Version, 512},
};

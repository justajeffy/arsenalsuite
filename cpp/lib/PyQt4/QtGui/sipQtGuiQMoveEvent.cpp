...
static PyObject *meth_QMoveEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QMoveEvent,&sipCpp))
        {
            QPoint *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QMoveEvent,sipName_pos);
...
static PyObject *meth_QMoveEvent_oldPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMoveEvent,sipName_oldPos);
...
extern "C" {static void *init_QMoveEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QMoveEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QMoveEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

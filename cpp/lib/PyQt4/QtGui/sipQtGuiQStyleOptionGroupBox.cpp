...
static void dealloc_QStyleOptionGroupBox(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionGroupBox(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionGroupBox(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionGroupBox(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionGroupBox,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionGroupBox[] = {{452, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionGroupBox[] = {
    {sipName_Type, QStyleOptionGroupBox::Type, 476},
    {sipName_Version, QStyleOptionGroupBox::Version, 477},
};

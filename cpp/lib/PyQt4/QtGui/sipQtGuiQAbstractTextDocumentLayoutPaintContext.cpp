...
static void dealloc_QAbstractTextDocumentLayout_PaintContext(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QAbstractTextDocumentLayout_PaintContext(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QAbstractTextDocumentLayout_PaintContext(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QAbstractTextDocumentLayout_PaintContext(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QAbstractTextDocumentLayout_PaintContext,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

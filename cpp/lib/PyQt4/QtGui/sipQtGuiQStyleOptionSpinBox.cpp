...
static void dealloc_QStyleOptionSpinBox(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionSpinBox(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionSpinBox(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionSpinBox(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionSpinBox,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionSpinBox[] = {{452, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionSpinBox[] = {
    {sipName_Type, QStyleOptionSpinBox::Type, 505},
    {sipName_Version, QStyleOptionSpinBox::Version, 506},
};

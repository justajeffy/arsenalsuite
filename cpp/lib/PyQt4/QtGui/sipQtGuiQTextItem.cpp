...
static PyObject *meth_QTextItem_descent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QTextItem,&sipCpp))
        {
            qreal sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_descent);
...
static PyObject *meth_QTextItem_ascent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_ascent);
...
static PyObject *meth_QTextItem_width(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_width);
...
static PyObject *meth_QTextItem_renderFlags(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_renderFlags);
...
static PyObject *meth_QTextItem_text(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_text);
...
static PyObject *meth_QTextItem_font(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextItem,sipName_font);
...
static void dealloc_QTextItem(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextItem(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextItem(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextItem(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    QTextItem *sipCpp = 0;
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextItem,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QTextItem[] = {
    {sipName_Overline, QTextItem::Overline, 621},
    {sipName_RightToLeft, QTextItem::RightToLeft, 621},
    {sipName_StrikeOut, QTextItem::StrikeOut, 621},
    {sipName_Underline, QTextItem::Underline, 621},
};

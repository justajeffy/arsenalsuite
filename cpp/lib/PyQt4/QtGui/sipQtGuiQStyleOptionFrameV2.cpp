...
static void dealloc_QStyleOptionFrameV2(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionFrameV2(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionFrameV2(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionFrameV2(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionFrameV2,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionFrame,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QStyleOptionFrameV2(*a0);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionFrameV2[] = {{463, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFrameV2[] = {
    {sipName_Flat, QStyleOptionFrameV2::Flat, 467},
    {sipName_None, QStyleOptionFrameV2::None, 467},
    {sipName_Version, QStyleOptionFrameV2::Version, 469},
};

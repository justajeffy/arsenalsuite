...
static PyObject *meth_QTextLength_type(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QTextLength,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QTextLength,sipName_type);
...
static PyObject *meth_QTextLength_value(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bd",&sipSelf,sipType_QTextLength,&sipCpp,&a0))
        {
            qreal sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextLength,sipName_value);
...
static PyObject *meth_QTextLength_rawValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextLength,sipName_rawValue);

    return NULL;
}


extern "C" {static PyObject *slot_QTextLength___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QTextLength___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QTextLength,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QTextLength___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QTextLength(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextLength(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextLength(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextLength(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"Ed",sipType_QTextLength_Type,&a0,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        {
#line 61 "sip/QtGui/qtextformat.sip"
        sipCpp = new QTextLength(qVariantValue<QTextLength>(*a0));
#line 277 "sipQtGuiQTextLength.cpp"
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextLength,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QTextLength[] = {
    {sipName_FixedLength, QTextLength::FixedLength, 627},
    {sipName_PercentageLength, QTextLength::PercentageLength, 627},
    {sipName_VariableLength, QTextLength::VariableLength, 627},
};

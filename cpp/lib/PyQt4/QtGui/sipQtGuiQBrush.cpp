...
static PyObject *meth_QBrush_setStyle(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QBrush,&sipCpp,sipType_Qt_BrushStyle,&a0))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setStyle);
...
static PyObject *meth_QBrush_texture(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QBrush,&sipCpp))
        {
            QPixmap *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_texture);
...
static PyObject *meth_QBrush_setTexture(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBrush,&sipCpp,sipType_QPixmap,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setTexture);
...
static PyObject *meth_QBrush_setColor(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QBrush,&sipCpp,sipType_QColor,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setColor(*a0);
            Py_END_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QBrush,&sipCpp,sipType_Qt_GlobalColor,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setColor(a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setColor);
...
static PyObject *meth_QBrush_gradient(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_gradient);
...
static PyObject *meth_QBrush_isOpaque(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_isOpaque);
...
static PyObject *meth_QBrush_style(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_style);
...
static PyObject *meth_QBrush_color(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_color);
...
static PyObject *meth_QBrush_setMatrix(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBrush,&sipCpp,sipType_QMatrix,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setMatrix(*a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setMatrix);
...
static PyObject *meth_QBrush_matrix(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_matrix);
...
static PyObject *meth_QBrush_setTextureImage(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBrush,&sipCpp,sipType_QImage,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setTextureImage);
...
static PyObject *meth_QBrush_textureImage(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_textureImage);
...
static PyObject *meth_QBrush_setTransform(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9",&sipSelf,sipType_QBrush,&sipCpp,sipType_QTransform,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_setTransform);
...
static PyObject *meth_QBrush_transform(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QBrush,sipName_transform);
...
static PyObject *slot_QBrush___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J1",sipType_QBrush,&a0,&a0State))
        {
            bool sipRes;
...
extern "C" {static void *init_QBrush(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QBrush(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    QBrush *sipCpp = 0;
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"E",sipType_Qt_BrushStyle,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1|E",sipType_QColor,&a0,&a0State,sipType_Qt_BrushStyle,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"E|E",sipType_Qt_GlobalColor,&a0,sipType_Qt_BrushStyle,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QBrush(a0,a1);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1J9",sipType_QColor,&a0,&a0State,sipType_QPixmap,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QBrush(*a0,*a1);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9",sipType_Qt_GlobalColor,&a0,sipType_QPixmap,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QBrush(a0,*a1);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QGradient,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QBrush(*a0);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J1",sipType_QBrush,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new QBrush(*a0);
            Py_END_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        {
#line 111 "sip/QtGui/qbrush.sip"
        sipCpp = new QBrush(qVariantValue<QBrush>(*a0));
#line 726 "sipQtGuiQBrush.cpp"

...
static void dealloc_QTextLayout_FormatRange(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextLayout_FormatRange(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextLayout_FormatRange(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextLayout_FormatRange(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextLayout_FormatRange,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

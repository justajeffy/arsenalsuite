...
const char * sipQDropEvent::format(int a0) const
{
    ...
    extern const char * sipVH_QtGui_147(sip_gilstate_t,PyObject *,bool*,int,int,sipSimpleWrapper *);

    return sipVH_QtGui_147(sipGILState,meth,0,a0,44,sipPySelf);
}
...
QByteArray sipQDropEvent::encodedData(const char *a0) const
{
    ...
    extern QByteArray sipVH_QtGui_145(sip_gilstate_t,PyObject *,bool*,const char *);

    return sipVH_QtGui_145(sipGILState,meth,0,a0);
}
...
bool sipQDropEvent::provides(const char *a0) const
{
    ...
    extern bool sipVH_QtGui_146(sip_gilstate_t,PyObject *,bool*,const char *);

    return sipVH_QtGui_146(sipGILState,meth,0,a0);
}
...
static PyObject *meth_QDropEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDropEvent,&sipCpp))
        {
            QPoint *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_pos);
...
static PyObject *meth_QDropEvent_mouseButtons(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_mouseButtons);
...
static PyObject *meth_QDropEvent_keyboardModifiers(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_keyboardModifiers);
...
static PyObject *meth_QDropEvent_possibleActions(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_possibleActions);
...
static PyObject *meth_QDropEvent_proposedAction(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_proposedAction);
...
static PyObject *meth_QDropEvent_acceptProposedAction(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_acceptProposedAction);
...
static PyObject *meth_QDropEvent_dropAction(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_dropAction);
...
static PyObject *meth_QDropEvent_setDropAction(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QDropEvent,&sipCpp,sipType_Qt_DropAction,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_setDropAction);
...
static PyObject *meth_QDropEvent_source(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_source);
...
static PyObject *meth_QDropEvent_mimeData(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_mimeData);
...
static PyObject *meth_QDropEvent_format(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B|i",&sipSelf,sipType_QDropEvent,&sipCpp,&a0))
        {
            const char *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_format);
...
static PyObject *meth_QDropEvent_encodedData(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bs",&sipSelf,sipType_QDropEvent,&sipCpp,&a0))
        {
            QByteArray *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_encodedData);
...
static PyObject *meth_QDropEvent_provides(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDropEvent,sipName_provides);
...
extern "C" {static void *init_QDropEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDropEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9J1J8J1J1|E",sipType_QPoint,&a0,sipType_Qt_DropActions,&a1,&a1State,sipType_QMimeData,&a2,sipType_Qt_MouseButtons,&a3,&a3State,sipType_Qt_KeyboardModifiers,&a4,&a4State,sipType_QEvent_Type,&a5))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDropEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QDropEvent[] = {{46, 0, 0}, {309, 255, 1}};

...
const char * sipQMimeSource::format(int a0) const
{
    ...
    return sipVH_QtGui_147(sipGILState,meth,0,a0,45,sipPySelf);
}
...
static PyObject *meth_QMimeSource_format(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B|i",&sipSelf,sipType_QMimeSource,&sipCpp,&a0))
        {
            const char *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QMimeSource,sipName_format);
...
static PyObject *meth_QMimeSource_provides(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bs",&sipSelf,sipType_QMimeSource,&sipCpp,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMimeSource,sipName_provides);
...
static PyObject *meth_QMimeSource_encodedData(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMimeSource,sipName_encodedData);
...
extern "C" {static void *init_QMimeSource(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QMimeSource(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QMimeSource,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

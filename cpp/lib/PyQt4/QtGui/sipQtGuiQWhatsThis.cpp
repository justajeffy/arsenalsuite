...
#line 39 "sip/QtGui/qwhatsthis.sip"
...
static PyObject *meth_QWhatsThis_enterWhatsThisMode(PyObject *, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_enterWhatsThisMode);
...
static PyObject *meth_QWhatsThis_inWhatsThisMode(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_inWhatsThisMode);
...
static PyObject *meth_QWhatsThis_leaveWhatsThisMode(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_leaveWhatsThisMode);

    return NULL;
}


extern "C" {static PyObject *meth_QWhatsThis_showText(PyObject *, PyObject *);}
static PyObject *meth_QWhatsThis_showText(PyObject *, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J9J1|J8",sipType_QPoint,&a0,sipType_QString,&a1,&a1State,sipType_QWidget,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_showText);
...
static PyObject *meth_QWhatsThis_hideText(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_hideText);

    return NULL;
}


extern "C" {static PyObject *meth_QWhatsThis_createAction(PyObject *, PyObject *);}
static PyObject *meth_QWhatsThis_createAction(PyObject *, PyObject *sipArgs)
{
    int sipArgsParsed = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWhatsThis,sipName_createAction);
...
static void dealloc_QWhatsThis(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QWhatsThis(sipSelf->u.cppPtr,0);
    }
}


static PyMethodDef methods_QWhatsThis[] = {
    {SIP_MLNAME_CAST(sipName_createAction), meth_QWhatsThis_createAction, METH_VARARGS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_showText), meth_QWhatsThis_showText, METH_VARARGS, NULL}
};

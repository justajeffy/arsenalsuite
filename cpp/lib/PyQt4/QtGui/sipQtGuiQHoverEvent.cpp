...
static PyObject *meth_QHoverEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QHoverEvent,&sipCpp))
        {
            QPoint *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QHoverEvent,sipName_pos);
...
static PyObject *meth_QHoverEvent_oldPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QHoverEvent,sipName_oldPos);
...
extern "C" {static void *init_QHoverEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QHoverEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QHoverEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QHoverEvent[] = {{46, 0, 1}};

...
static void dealloc_QStyleOptionViewItemV4(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionViewItemV4(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionViewItemV4(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionViewItemV4(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionViewItemV4,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionViewItemV4[] = {{555, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionViewItemV4[] = {
    {sipName_Beginning, QStyleOptionViewItemV4::Beginning, 559},
    {sipName_End, QStyleOptionViewItemV4::End, 559},
    {sipName_Invalid, QStyleOptionViewItemV4::Invalid, 559},
    {sipName_Middle, QStyleOptionViewItemV4::Middle, 559},
    {sipName_OnlyOne, QStyleOptionViewItemV4::OnlyOne, 559},
    {sipName_Version, QStyleOptionViewItemV4::Version, 558},
};

...
static PyObject *meth_QMouseEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QMouseEvent,&sipCpp))
        {
            QPoint *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_pos);
...
static PyObject *meth_QMouseEvent_globalPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_globalPos);
...
static PyObject *meth_QMouseEvent_x(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_x);
...
static PyObject *meth_QMouseEvent_y(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_y);
...
static PyObject *meth_QMouseEvent_globalX(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_globalX);
...
static PyObject *meth_QMouseEvent_globalY(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_globalY);
...
static PyObject *meth_QMouseEvent_button(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_button);
...
static PyObject *meth_QMouseEvent_buttons(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_buttons);
...
static PyObject *meth_QMouseEvent_hasExtendedInfo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_hasExtendedInfo);
...
static PyObject *meth_QMouseEvent_posF(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QMouseEvent,sipName_posF);
...
extern "C" {static void *init_QMouseEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QMouseEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9EJ1J1",sipType_QEvent_Type,&a0,sipType_QPoint,&a1,sipType_Qt_MouseButton,&a2,sipType_Qt_MouseButtons,&a3,&a3State,sipType_Qt_KeyboardModifiers,&a4,&a4State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"EJ9J9EJ1J1",sipType_QEvent_Type,&a0,sipType_QPoint,&a1,sipType_QPoint,&a2,sipType_Qt_MouseButton,&a3,sipType_Qt_MouseButtons,&a4,&a4State,sipType_Qt_KeyboardModifiers,&a5,&a5State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QMouseEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QMouseEvent[] = {{223, 255, 1}};

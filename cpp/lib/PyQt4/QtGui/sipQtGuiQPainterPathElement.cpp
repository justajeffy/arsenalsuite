...
static PyObject *meth_QPainterPath_Element_isMoveTo(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QPainterPath_Element,&sipCpp))
        {
            bool sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_Element,sipName_isMoveTo);
...
static PyObject *meth_QPainterPath_Element_isLineTo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_Element,sipName_isLineTo);
...
static PyObject *meth_QPainterPath_Element_isCurveTo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_Element,sipName_isCurveTo);

    return NULL;
}


extern "C" {static PyObject *slot_QPainterPath_Element___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QPainterPath_Element___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QPainterPath_Element,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QPainterPath_Element___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QPainterPath_Element(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QPainterPath_Element(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QPainterPath_Element(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QPainterPath_Element(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{

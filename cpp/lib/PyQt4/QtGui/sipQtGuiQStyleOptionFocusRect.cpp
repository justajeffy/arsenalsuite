...
static void dealloc_QStyleOptionFocusRect(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionFocusRect(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionFocusRect(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionFocusRect(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionFocusRect,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionFocusRect[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFocusRect[] = {
    {sipName_Type, QStyleOptionFocusRect::Type, 461},
    {sipName_Version, QStyleOptionFocusRect::Version, 462},
};

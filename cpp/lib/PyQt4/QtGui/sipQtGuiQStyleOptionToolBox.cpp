...
static void dealloc_QStyleOptionToolBox(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionToolBox(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionToolBox(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionToolBox(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QStyleOptionToolBox[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionToolBox[] = {
    {sipName_Type, QStyleOptionToolBox::Type, 536},
    {sipName_Version, QStyleOptionToolBox::Version, 537},
};

...
static void dealloc_QStyleOptionSlider(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionSlider(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionSlider(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionSlider(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionSlider,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionSlider[] = {{452, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionSlider[] = {
    {sipName_Type, QStyleOptionSlider::Type, 502},
    {sipName_Version, QStyleOptionSlider::Version, 503},
};

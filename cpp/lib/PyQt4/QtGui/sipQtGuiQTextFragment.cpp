...
static PyObject *meth_QTextFragment_isValid(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QTextFragment,&sipCpp))
        {
            bool sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_isValid);
...
static PyObject *meth_QTextFragment_position(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_position);
...
static PyObject *meth_QTextFragment_length(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_length);
...
static PyObject *meth_QTextFragment_contains(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bi",&sipSelf,sipType_QTextFragment,&sipCpp,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_contains);
...
static PyObject *meth_QTextFragment_charFormat(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_charFormat);
...
static PyObject *meth_QTextFragment_charFormatIndex(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_charFormatIndex);
...
static PyObject *meth_QTextFragment_text(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QTextFragment,sipName_text);

    return NULL;
}


extern "C" {static PyObject *slot_QTextFragment___ge__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QTextFragment___ge__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QTextFragment,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QTextFragment___lt__(PyObject *sipSelf,PyObject *sipArg);}
...
extern "C" {static PyObject *slot_QTextFragment___ne__(PyObject *sipSelf,PyObject *sipArg);}
...
extern "C" {static PyObject *slot_QTextFragment___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QTextFragment(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QTextFragment(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QTextFragment(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QTextFragment(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QTextFragment,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

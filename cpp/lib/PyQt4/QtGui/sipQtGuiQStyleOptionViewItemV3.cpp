...
static void dealloc_QStyleOptionViewItemV3(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionViewItemV3(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionViewItemV3(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionViewItemV3(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionViewItemV3,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionViewItemV3[] = {{551, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionViewItemV3[] = {
    {sipName_Version, QStyleOptionViewItemV3::Version, 556},
};

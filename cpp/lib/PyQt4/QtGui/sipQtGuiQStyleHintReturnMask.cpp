...
static void dealloc_QStyleHintReturnMask(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleHintReturnMask(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleHintReturnMask(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleHintReturnMask(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleHintReturnMask,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleHintReturnMask[] = {{430, 255, 1}};

static sipEnumMemberDef enummembers_QStyleHintReturnMask[] = {
    {sipName_Type, QStyleHintReturnMask::Type, 435},
    {sipName_Version, QStyleHintReturnMask::Version, 436},
};

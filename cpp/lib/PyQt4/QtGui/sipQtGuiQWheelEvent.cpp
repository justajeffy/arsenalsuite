...
static PyObject *meth_QWheelEvent_delta(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QWheelEvent,&sipCpp))
        {
            int sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_delta);
...
static PyObject *meth_QWheelEvent_pos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_pos);
...
static PyObject *meth_QWheelEvent_globalPos(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_globalPos);
...
static PyObject *meth_QWheelEvent_x(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_x);
...
static PyObject *meth_QWheelEvent_y(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_y);
...
static PyObject *meth_QWheelEvent_globalX(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_globalX);
...
static PyObject *meth_QWheelEvent_globalY(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_globalY);
...
static PyObject *meth_QWheelEvent_buttons(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_buttons);
...
static PyObject *meth_QWheelEvent_orientation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWheelEvent,sipName_orientation);
...
extern "C" {static void *init_QWheelEvent(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWheelEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9iJ1J1|E",sipType_QPoint,&a0,&a1,sipType_Qt_MouseButtons,&a2,&a2State,sipType_Qt_KeyboardModifiers,&a3,&a3State,sipType_Qt_Orientation,&a4))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9J9iJ1J1|E",sipType_QPoint,&a0,sipType_QPoint,&a1,&a2,sipType_Qt_MouseButtons,&a3,&a3State,sipType_Qt_KeyboardModifiers,&a4,&a4State,sipType_Qt_Orientation,&a5))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QWheelEvent,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QWheelEvent[] = {{223, 255, 1}};

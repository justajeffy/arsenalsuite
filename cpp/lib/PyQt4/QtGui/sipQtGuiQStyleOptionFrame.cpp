...
static void dealloc_QStyleOptionFrame(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionFrame(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QStyleOptionFrame(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionFrame(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
...
static sipEncodedTypeDef supers_QStyleOptionFrame[] = {{440, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFrame[] = {
    {sipName_Type, QStyleOptionFrame::Type, 464},
    {sipName_Version, QStyleOptionFrame::Version, 465},
};

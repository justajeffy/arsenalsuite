...
extern "C" {static void *init_QStyleOptionComboBox(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QStyleOptionComboBox(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QStyleOptionComboBox,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QStyleOptionComboBox[] = {{452, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionComboBox[] = {
    {sipName_Type, QStyleOptionComboBox::Type, 450},
    {sipName_Version, QStyleOptionComboBox::Version, 451},
};

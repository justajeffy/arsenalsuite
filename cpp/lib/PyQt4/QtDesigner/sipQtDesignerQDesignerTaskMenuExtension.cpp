...
#line 37 "sip/QtDesigner/taskmenu.sip"
#include <taskmenu.h>
...
static PyObject *meth_QDesignerTaskMenuExtension_taskActions(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDesignerTaskMenuExtension,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QDesignerTaskMenuExtension,sipName_taskActions);
...
static PyObject *meth_QDesignerTaskMenuExtension_preferredEditAction(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDesignerTaskMenuExtension,sipName_preferredEditAction);
...
extern "C" {static void *init_QDesignerTaskMenuExtension(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDesignerTaskMenuExtension(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDesignerTaskMenuExtension,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

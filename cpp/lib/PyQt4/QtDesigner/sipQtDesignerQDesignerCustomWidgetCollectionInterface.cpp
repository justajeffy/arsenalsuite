...
#line 60 "sip/QtDesigner/customwidget.sip"
...
static PyObject *meth_QDesignerCustomWidgetCollectionInterface_customWidgets(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDesignerCustomWidgetCollectionInterface,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QDesignerCustomWidgetCollectionInterface,sipName_customWidgets);
...
static void dealloc_QDesignerCustomWidgetCollectionInterface(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQDesignerCustomWidgetCollectionInterface *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QDesignerCustomWidgetCollectionInterface(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QDesignerCustomWidgetCollectionInterface(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDesignerCustomWidgetCollectionInterface(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDesignerCustomWidgetCollectionInterface,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

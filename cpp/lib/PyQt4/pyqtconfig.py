...
_pkg_config = {
    'pyqt_bin_dir':      'c:\\python24',
    'pyqt_config_args':  '-w',
    'pyqt_mod_dir':      'c:\\python24\\Lib\\site-packages\\PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml phonon QtAssistant QtDesigner QAxContainer',
    'pyqt_sip_dir':      'c:\\python24\\sip\\PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_6_1 -x Py_v3 -g',
    'pyqt_version':      0x040805,
    'pyqt_version_str':  'snapshot-4.8.5-a9b83eac34c4',
    'qt_data_dir':       'C:\\Qt\\4.6.1',
    'qt_dir':            'C:\\Qt\\4.6.1',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Qt\\4.6.1\\include',
    'qt_lib_dir':        'C:\\Qt\\4.6.1\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040601,
    'qt_winconfig':      'shared'
}

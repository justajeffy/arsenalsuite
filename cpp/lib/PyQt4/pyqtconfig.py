...
_pkg_config = {
    ...
    'pyqt_config_args':  '',
    'pyqt_mod_dir':      '/usr/lib/python2.5/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtNetwork QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns phonon QtAssistant QtDesigner',
    ...
    'qt_data_dir':       '/usr/local/Trolltech/Qt-4.5.3',
    'qt_dir':            '/usr/local/Trolltech/Qt-4.5.3',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/usr/local/Trolltech/Qt-4.5.3/include',
    'qt_lib_dir':        '/usr/local/Trolltech/Qt-4.5.3/lib',
    'qt_threaded':       1,
    'qt_version':        0x040503,
    'qt_winconfig':      'shared'
}

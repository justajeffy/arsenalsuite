...
#line 37 "sip/QtOpenGL/qglpixelbuffer.sip"
...
static PyObject *meth_QGLPixelBuffer_isValid(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QGLPixelBuffer,&sipCpp))
        {
            bool sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_isValid);
...
static PyObject *meth_QGLPixelBuffer_makeCurrent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_makeCurrent);
...
static PyObject *meth_QGLPixelBuffer_doneCurrent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_doneCurrent);
...
static PyObject *meth_QGLPixelBuffer_generateDynamicTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_generateDynamicTexture);
...
static PyObject *meth_QGLPixelBuffer_bindToDynamicTexture(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bu",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,&a0))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_bindToDynamicTexture);
...
static PyObject *meth_QGLPixelBuffer_releaseFromDynamicTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_releaseFromDynamicTexture);
...
static PyObject *meth_QGLPixelBuffer_updateDynamicTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_updateDynamicTexture);

    return NULL;
}


extern "C" {static PyObject *meth_QGLPixelBuffer_bindTexture(PyObject *, PyObject *);}
static PyObject *meth_QGLPixelBuffer_bindTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9|u",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QImage,&a0,&a1))
        {
            GLuint sipRes;
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9|u",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QPixmap,&a0,&a1))
        {
            GLuint sipRes;
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QString,&a0,&a0State))
        {
            GLuint sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_bindTexture);

    return NULL;
}


extern "C" {static PyObject *meth_QGLPixelBuffer_drawTexture(PyObject *, PyObject *);}
static PyObject *meth_QGLPixelBuffer_drawTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9u|u",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QRectF,&a0,&a1,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ9u|u",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QPointF,&a0,&a1,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->drawTexture(*a0,a1,a2);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_drawTexture);
...
static PyObject *meth_QGLPixelBuffer_deleteTexture(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_deleteTexture);
...
static PyObject *meth_QGLPixelBuffer_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_size);
...
static PyObject *meth_QGLPixelBuffer_handle(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_handle);
...
static PyObject *meth_QGLPixelBuffer_toImage(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_toImage);
...
static PyObject *meth_QGLPixelBuffer_paintEngine(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_paintEngine);
...
static PyObject *meth_QGLPixelBuffer_format(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_format);
...
static PyObject *meth_QGLPixelBuffer_hasOpenGLPbuffers(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_hasOpenGLPbuffers);
...
static PyObject *meth_QGLPixelBuffer_metric(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pE",&sipSelf,sipType_QGLPixelBuffer,&sipCpp,sipType_QPaintDevice_PaintDeviceMetric,&a0))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_metric);
...
static PyObject *meth_QGLPixelBuffer_devType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"p",&sipSelf,sipType_QGLPixelBuffer,&sipCpp))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLPixelBuffer,sipName_devType);
...
static void dealloc_QGLPixelBuffer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQGLPixelBuffer *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QGLPixelBuffer(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QGLPixelBuffer(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QGLPixelBuffer(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9|J9J8",sipType_QSize,&a0,sipType_QGLFormat,&a1,sipType_QGLWidget,&a2))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"ii|J9J8",&a0,&a1,sipType_QGLFormat,&a2,sipType_QGLWidget,&a3))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QGLPixelBuffer[] = {{318, 1, 1}};


static PyMethodDef methods_QGLPixelBuffer[] = {
    {SIP_MLNAME_CAST(sipName_bindTexture), meth_QGLPixelBuffer_bindTexture, METH_VARARGS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_drawTexture), meth_QGLPixelBuffer_drawTexture, METH_VARARGS, NULL},

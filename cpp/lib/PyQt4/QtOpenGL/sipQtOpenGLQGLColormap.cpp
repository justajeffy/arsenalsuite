...
static PyObject *meth_QGLColormap_detach(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QGLColormap,&sipCpp))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_detach);
...
static PyObject *meth_QGLColormap_isEmpty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_isEmpty);
...
static PyObject *meth_QGLColormap_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_size);

    return NULL;
}


extern "C" {static PyObject *meth_QGLColormap_setEntries(PyObject *, PyObject *);}
static PyObject *meth_QGLColormap_setEntries(PyObject *sipSelf, PyObject *sipArgs)
{
    int sipArgsParsed = 0;

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BT|i",&sipSelf,sipType_QGLColormap,&sipCpp,&PyList_Type,&a0,&a1))
        {
#line 49 "sip/QtOpenGL/qglcolormap.sip"
        ...
        delete[] colours;
#line 194 "sipQtOpenGLQGLColormap.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_setEntries);
...
static PyObject *meth_QGLColormap_setEntry(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Biu",&sipSelf,sipType_QGLColormap,&sipCpp,&a0,&a1))
        {
            Py_BEGIN_ALLOW_THREADS
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BiJ1",&sipSelf,sipType_QGLColormap,&sipCpp,&a0,sipType_QColor,&a1,&a1State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setEntry(a0,*a1);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_setEntry);
...
static PyObject *meth_QGLColormap_entryRgb(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bi",&sipSelf,sipType_QGLColormap,&sipCpp,&a0))
        {
            QRgb sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_entryRgb);
...
static PyObject *meth_QGLColormap_entryColor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_entryColor);
...
static PyObject *meth_QGLColormap_find(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bu",&sipSelf,sipType_QGLColormap,&sipCpp,&a0))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_find);
...
static PyObject *meth_QGLColormap_findNearest(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_findNearest);
...
static PyObject *meth_QGLColormap_handle(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"p",&sipSelf,sipType_QGLColormap,&sipCpp))
        {
            Qt::HANDLE sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_handle);
...
static PyObject *meth_QGLColormap_setHandle(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"pm",&sipSelf,sipType_QGLColormap,&sipCpp,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QGLColormap,sipName_setHandle);
...
static void dealloc_QGLColormap(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQGLColormap *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QGLColormap(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QGLColormap(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QGLColormap(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QGLColormap,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_QGLColormap[] = {
    ...
    {SIP_MLNAME_CAST(sipName_setEntries), meth_QGLColormap_setEntries, METH_VARARGS, NULL},

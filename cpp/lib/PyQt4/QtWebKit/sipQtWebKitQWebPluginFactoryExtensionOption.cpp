...
static void dealloc_QWebPluginFactory_ExtensionOption(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QWebPluginFactory_ExtensionOption(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QWebPluginFactory_ExtensionOption(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWebPluginFactory_ExtensionOption(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QWebPluginFactory_ExtensionOption,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

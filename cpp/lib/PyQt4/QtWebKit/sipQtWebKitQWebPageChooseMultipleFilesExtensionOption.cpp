...
#include <qwebpage.h>
#line 47 "sipQtWebKitQWebPageChooseMultipleFilesExtensionOption.cpp"
...
#line 54 "sipQtWebKitQWebPageChooseMultipleFilesExtensionOption.cpp"
...
static void dealloc_QWebPage_ChooseMultipleFilesExtensionOption(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QWebPage_ChooseMultipleFilesExtensionOption(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QWebPage_ChooseMultipleFilesExtensionOption(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWebPage_ChooseMultipleFilesExtensionOption(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QWebPage_ChooseMultipleFilesExtensionOption,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QWebPage_ChooseMultipleFilesExtensionOption[] = {{17, 255, 1}};

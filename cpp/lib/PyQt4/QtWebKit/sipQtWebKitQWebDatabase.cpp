...
static PyObject *meth_QWebDatabase_name(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QWebDatabase,&sipCpp))
        {
            QString *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_name);
...
static PyObject *meth_QWebDatabase_displayName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_displayName);
...
static PyObject *meth_QWebDatabase_expectedSize(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_expectedSize);
...
static PyObject *meth_QWebDatabase_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_size);
...
static PyObject *meth_QWebDatabase_fileName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_fileName);
...
static PyObject *meth_QWebDatabase_origin(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_origin);
...
static PyObject *meth_QWebDatabase_removeDatabase(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J9",sipType_QWebDatabase,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QWebDatabase,sipName_removeDatabase);
...
static void dealloc_QWebDatabase(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QWebDatabase(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QWebDatabase(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWebDatabase(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{

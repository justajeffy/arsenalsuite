...
static void dealloc_QWebPluginFactory_Plugin(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QWebPluginFactory_Plugin(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QWebPluginFactory_Plugin(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QWebPluginFactory_Plugin(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QWebPluginFactory_Plugin,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

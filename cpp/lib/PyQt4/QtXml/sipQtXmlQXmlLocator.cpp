...
int sipQXmlLocator::columnNumber() const
{
    ...
    return ((sipVH_QtCore_7)(sipModuleAPI_QtXml_QtCore->em_virthandlers[7]))(sipGILState,meth,0);
}
...
static PyObject *meth_QXmlLocator_columnNumber(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QXmlLocator,&sipCpp))
        {
            int sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QXmlLocator,sipName_columnNumber);
...
static PyObject *meth_QXmlLocator_lineNumber(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QXmlLocator,sipName_lineNumber);
...
static void dealloc_QXmlLocator(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQXmlLocator *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QXmlLocator(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QXmlLocator(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QXmlLocator(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QXmlLocator,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

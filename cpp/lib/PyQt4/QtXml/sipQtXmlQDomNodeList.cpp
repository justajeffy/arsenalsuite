...
static PyObject *meth_QDomNodeList_item(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bi",&sipSelf,sipType_QDomNodeList,&sipCpp,&a0))
        {
            QDomNode *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_item);
...
static PyObject *meth_QDomNodeList_length(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDomNodeList,&sipCpp))
        {
            uint sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_length);
...
static PyObject *meth_QDomNodeList_count(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_count);
...
static PyObject *meth_QDomNodeList_at(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_at);
...
static PyObject *meth_QDomNodeList_size(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_size);
...
static PyObject *meth_QDomNodeList_isEmpty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomNodeList,sipName_isEmpty);

    return NULL;
}


extern "C" {static PyObject *slot_QDomNodeList___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QDomNodeList___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QDomNodeList,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QDomNodeList___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QDomNodeList(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QDomNodeList(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QDomNodeList(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDomNodeList(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDomNodeList,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

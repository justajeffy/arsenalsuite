...
static PyObject *meth_QDomImplementation_hasFeature(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1J1",&sipSelf,sipType_QDomImplementation,&sipCpp,sipType_QString,&a0,&a0State,sipType_QString,&a1,&a1State))
        {
            bool sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_hasFeature);
...
static PyObject *meth_QDomImplementation_createDocumentType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1J1J1",&sipSelf,sipType_QDomImplementation,&sipCpp,sipType_QString,&a0,&a0State,sipType_QString,&a1,&a1State,sipType_QString,&a2,&a2State))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_createDocumentType);
...
static PyObject *meth_QDomImplementation_createDocument(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1J1J9",&sipSelf,sipType_QDomImplementation,&sipCpp,sipType_QString,&a0,&a0State,sipType_QString,&a1,&a1State,sipType_QDomDocumentType,&a2))
        {
            QDomDocument *sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_createDocument);
...
static PyObject *meth_QDomImplementation_isNull(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QDomImplementation,&sipCpp))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_isNull);
...
static PyObject *meth_QDomImplementation_invalidDataPolicy(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_invalidDataPolicy);
...
static PyObject *meth_QDomImplementation_setInvalidDataPolicy(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"E",sipType_QDomImplementation_InvalidDataPolicy,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QDomImplementation,sipName_setInvalidDataPolicy);

    return NULL;
}


extern "C" {static PyObject *slot_QDomImplementation___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QDomImplementation___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QDomImplementation,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QDomImplementation___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QDomImplementation(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QDomImplementation(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QDomImplementation(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QDomImplementation(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QDomImplementation,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

...
static PyObject *meth_QSqlRelation_tableName(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QSqlRelation,&sipCpp))
        {
            QString *sipRes;
    ...
    sipNoMethod(sipArgsParsed,sipName_QSqlRelation,sipName_tableName);
...
static PyObject *meth_QSqlRelation_indexColumn(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSqlRelation,sipName_indexColumn);
...
static PyObject *meth_QSqlRelation_displayColumn(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSqlRelation,sipName_displayColumn);
...
static PyObject *meth_QSqlRelation_isValid(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QSqlRelation,sipName_isValid);
...
extern "C" {static void *init_QSqlRelation(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QSqlRelation(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"J9",sipType_QSqlRelation,&a0))
        {
            Py_BEGIN_ALLOW_THREADS

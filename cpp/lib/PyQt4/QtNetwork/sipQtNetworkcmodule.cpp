...
#line 41 "sip/QtNetwork/qudpsocket.sip"
...
#line 35 "sip/QtNetwork/qabstractnetworkcache.sip"
#include <qabstractnetworkcache.h>
#line 34 "sip/QtNetwork/qhostaddress.sip"
#include <qhostaddress.h>
#line 35 "sip/QtNetwork/qnetworkinterface.sip"
#include <qnetworkinterface.h>
#line 34 "sip/QtNetwork/qudpsocket.sip"
#include <qudpsocket.h>
#line 789 "sipQtNetworkcmodule.cpp"

void sipVH_QtNetwork_0(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QDateTime& a0)
{
...
void sipVH_QtNetwork_1(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,int a0)
{
...
void sipVH_QtNetwork_2(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,bool a0)
{
...
void sipVH_QtNetwork_3(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,PY_LONG_LONG a0)
{
...
QTcpSocket * sipVH_QtNetwork_4(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error)
{
    QTcpSocket * sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"");

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D4",sipType_QTcpSocket,&sipRes) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
...
QList<QNetworkProxy> sipVH_QtNetwork_5(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QNetworkProxyQuery& a0)
{
    QList<QNetworkProxy> sipRes;
    QList<QNetworkProxy> *sipResOrig;
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QNetworkProxyQuery *>(&a0),sipType_QNetworkProxyQuery,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D5",sipType_QList_0100QNetworkProxy,&sipResOrig) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
    else
...
void sipVH_QtNetwork_6(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,QIODevice *a0)
{
...
QIODevice * sipVH_QtNetwork_7(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QNetworkCacheMetaData& a0)
{
    QIODevice * sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QNetworkCacheMetaData *>(&a0),sipType_QNetworkCacheMetaData,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D4",sipType_QIODevice,&sipRes) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
...
bool sipVH_QtNetwork_8(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QUrl& a0)
{
    bool sipRes = 0;
...
QIODevice * sipVH_QtNetwork_9(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QUrl& a0)
{
    QIODevice * sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QUrl *>(&a0),sipType_QUrl,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D6",sipType_QIODevice,&sipRes) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
...
void sipVH_QtNetwork_10(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QNetworkCacheMetaData& a0)
{
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QNetworkCacheMetaData *>(&a0),sipType_QNetworkCacheMetaData,NULL);
...
QNetworkCacheMetaData sipVH_QtNetwork_11(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QUrl& a0)
{
    QNetworkCacheMetaData sipRes;
    QNetworkCacheMetaData *sipResOrig;
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QUrl *>(&a0),sipType_QUrl,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D5",sipType_QNetworkCacheMetaData,&sipResOrig) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
    else
...
bool sipVH_QtNetwork_12(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QList<QNetworkCookie>& a0,const QUrl& a1)
{
    bool sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"DD",const_cast<QList<QNetworkCookie> *>(&a0),sipType_QList_0100QNetworkCookie,NULL,const_cast<QUrl *>(&a1),sipType_QUrl,NULL);
...
QList<QNetworkCookie> sipVH_QtNetwork_13(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QUrl& a0)
{
    QList<QNetworkCookie> sipRes;
    QList<QNetworkCookie> *sipResOrig;
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",const_cast<QUrl *>(&a0),sipType_QUrl,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D5",sipType_QList_0100QNetworkCookie,&sipResOrig) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
    else
...
QNetworkReply * sipVH_QtNetwork_14(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,QNetworkAccessManager::Operation a0,const QNetworkRequest& a1,QIODevice *a2)
{
    QNetworkReply * sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"FDD",a0,sipType_QNetworkAccessManager_Operation,const_cast<QNetworkRequest *>(&a1),sipType_QNetworkRequest,NULL,a2,sipType_QIODevice,NULL);

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D6",sipType_QNetworkReply,&sipRes) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
...
void sipVH_QtNetwork_15(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,quintptr a0)
{
    PyObject *resObj = sipCallMethod(0,sipMethod,"D",&a0,sipType_quintptr,NULL);
...
QLocalSocket * sipVH_QtNetwork_16(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error)
{
    QLocalSocket * sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"");

    if (!resObj || sipParseResult(0,sipMethod,resObj,"D4",sipType_QLocalSocket,&sipRes) < 0) {
        if (error) *error = true;
        else       PyErr_Print();
    }
...
bool sipVH_QtNetwork_17(sip_gilstate_t sipGILState,PyObject *sipMethod,bool *error,const QString& a0,int a1)
{
    bool sipRes = 0;
    PyObject *resObj = sipCallMethod(0,sipMethod,"Di",const_cast<QString *>(&a0),sipType_QString,NULL,a1);
...
static PyObject *slot___rshift__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J9J9",sipType_QDataStream,&a0,sipType_QNetworkCacheMetaData,&a1))
        {
            QDataStream *sipRes;
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"J9J9",sipType_QDataStream,&a0,sipType_QHostAddress,&a1))
        {
            QDataStream *sipRes;
...
#line 41 "sip/QtNetwork/qabstractsocket.sip"
    static struct class_graph {
        ...
        {0,	0,	-1, 1},
    #endif
        {sipName_QAbstractSocket, &sipType_QAbstractSocket, 10, 2},
    #if QT_VERSION >= 0x040500
        {sipName_QAbstractNetworkCache, &sipType_QAbstractNetworkCache, 13, 3},
    #else
        {0,	0,	13, 3},
    #endif
    #if QT_VERSION >= 0x040400
    ...
    #endif
    #if QT_VERSION >= 0x040400
        {sipName_QNetworkReply, &sipType_QNetworkReply, -1, 5},
    #else
        {0,	0,	-1, 5},
    #endif
    #if QT_VERSION >= 0x040400
        {sipName_QNetworkAccessManager, &sipType_QNetworkAccessManager, -1, 6},
    #else
        {0,	0,	-1, 6},
    #endif
        {sipName_QFtp, &sipType_QFtp, -1, 7},
    #if QT_VERSION >= 0x040400
        {sipName_QLocalSocket, &sipType_QLocalSocket, -1, 8},
    #else
        {0,	0,	-1, 8},
    #endif
        {sipName_QTcpServer, &sipType_QTcpServer, -1, 9},
        {sipName_QHttp, &sipType_QHttp, -1, -1},
        {sipName_QUdpSocket, &sipType_QUdpSocket, -1, 11},
        {sipName_QTcpSocket, &sipType_QTcpSocket, 12, -1},
    ...
    while (i >= 0);
#line 1280 "sipQtNetworkcmodule.cpp"

    return sipType;
}


extern "C" {static PyObject *slot_QUdpSocket_BindFlag___or__(PyObject *sipArg0,PyObject *sipArg1);}
static PyObject *slot_QUdpSocket_BindFlag___or__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        QUdpSocket::BindFlag a1;

        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"EE",sipType_QUdpSocket_BindFlag,&a0,sipType_QUdpSocket_BindFlag,&a1))
        {
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"EJ1",sipType_QUdpSocket_BindFlag,&a0,sipType_QUdpSocket_BindMode,&a1,&a1State))
        {
            QUdpSocket::BindMode *sipRes;
...
extern "C" {static PyObject *slot_QNetworkInterface_InterfaceFlag___or__(PyObject *sipArg0,PyObject *sipArg1);}
static PyObject *slot_QNetworkInterface_InterfaceFlag___or__(PyObject *sipArg0,PyObject *sipArg1)
{
...

    {
        ...
        QNetworkInterface::InterfaceFlag a1;

        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"EE",sipType_QNetworkInterface_InterfaceFlag,&a0,sipType_QNetworkInterface_InterfaceFlag,&a1))
        {
...

    {
        ...
        if (sipParsePair(&sipArgsParsed,sipArg0,sipArg1,"EJ1",sipType_QNetworkInterface_InterfaceFlag,&a0,sipType_QNetworkInterface_InterfaceFlags,&a1,&a1State))
        {
            QNetworkInterface::InterfaceFlags *sipRes;
...
extern "C" {static PyObject *slot_QHostAddress_SpecialAddress___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QUrlInfo__PermissionSpec, {0}}, sipNameNr_PermissionSpec, 84, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QUdpSocket__BindFlag, {0}}, sipNameNr_BindFlag, 81, slots_QUdpSocket_BindFlag},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSslSocket__PeerVerifyMode, {0}}, sipNameNr_PeerVerifyMode, 76, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSslSocket__SslMode, {0}}, sipNameNr_SslMode, 76, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSslError__SslError, {0}}, sipNameNr_SslError, 73, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSslCertificate__SubjectInfo, {0}}, sipNameNr_SubjectInfo, 69, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSsl__SslProtocol, {0}}, sipNameNr_SslProtocol, 63, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSsl__AlternateNameEntryType, {0}}, sipNameNr_AlternateNameEntryType, 63, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSsl__KeyAlgorithm, {0}}, sipNameNr_KeyAlgorithm, 63, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSsl__EncodingFormat, {0}}, sipNameNr_EncodingFormat, 63, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QSsl__KeyType, {0}}, sipNameNr_KeyType, 63, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkRequest__CacheLoadControl, {0}}, sipNameNr_CacheLoadControl, 58, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkRequest__Attribute, {0}}, sipNameNr_Attribute, 58, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkRequest__KnownHeaders, {0}}, sipNameNr_KnownHeaders, 58, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkReply__NetworkError, {0}}, sipNameNr_NetworkError, 56, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkProxyQuery__QueryType, {0}}, sipNameNr_QueryType, 54, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkProxy__Capability, {0}}, sipNameNr_Capability, 49, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkProxy__ProxyType, {0}}, sipNameNr_ProxyType, 49, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkInterface__InterfaceFlag, {0}}, sipNameNr_InterfaceFlag, 46, slots_QNetworkInterface_InterfaceFlag},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkCookie__RawForm, {0}}, sipNameNr_RawForm, 42, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QNetworkAccessManager__Operation, {0}}, sipNameNr_Operation, 38, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QLocalSocket__LocalSocketState, {0}}, sipNameNr_LocalSocketState, 34, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QLocalSocket__LocalSocketError, {0}}, sipNameNr_LocalSocketError, 34, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QHttp__Error, {0}}, sipNameNr_Error, 18, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QHttp__State, {0}}, sipNameNr_State, 18, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QHttp__ConnectionMode, {0}}, sipNameNr_ConnectionMode, 18, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QHostInfo__HostInfoError, {0}}, sipNameNr_HostInfoError, 16, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QHostAddress__SpecialAddress, {0}}, sipNameNr_SpecialAddress, 14, slots_QHostAddress_SpecialAddress},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QFtp__TransferType, {0}}, sipNameNr_TransferType, 7, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QFtp__TransferMode, {0}}, sipNameNr_TransferMode, 7, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QFtp__Command, {0}}, sipNameNr_Command, 7, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QFtp__Error, {0}}, sipNameNr_Error, 7, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_QFtp__State, {0}}, sipNameNr_State, 7, NULL},
...
static sipSubClassConvertorDef convertorsTable[] = {
    {sipSubClass_QAbstractSocket, {111, 0, 0}, NULL},
    {NULL, {0, 0, 0}, NULL}
};

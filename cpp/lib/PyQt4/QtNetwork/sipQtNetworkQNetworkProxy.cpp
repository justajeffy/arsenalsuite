...
static PyObject *meth_QNetworkProxy_setType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BE",&sipSelf,sipType_QNetworkProxy,&sipCpp,sipType_QNetworkProxy_ProxyType,&a0))
        {
    ...
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setType);
...
static PyObject *meth_QNetworkProxy_type(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"B",&sipSelf,sipType_QNetworkProxy,&sipCpp))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_type);
...
static PyObject *meth_QNetworkProxy_setUser(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QNetworkProxy,&sipCpp,sipType_QString,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setUser(*a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setUser);
...
static PyObject *meth_QNetworkProxy_user(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_user);
...
static PyObject *meth_QNetworkProxy_setPassword(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setPassword);
...
static PyObject *meth_QNetworkProxy_password(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_password);
...
static PyObject *meth_QNetworkProxy_setHostName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setHostName);
...
static PyObject *meth_QNetworkProxy_hostName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_hostName);
...
static PyObject *meth_QNetworkProxy_setPort(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"Bt",&sipSelf,sipType_QNetworkProxy,&sipCpp,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setPort(a0);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setPort);
...
static PyObject *meth_QNetworkProxy_port(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_port);
...
static PyObject *meth_QNetworkProxy_setApplicationProxy(PyObject *, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"J9",sipType_QNetworkProxy,&a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setApplicationProxy);
...
static PyObject *meth_QNetworkProxy_applicationProxy(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_applicationProxy);
...
static PyObject *meth_QNetworkProxy_isCachingProxy(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_isCachingProxy);
...
static PyObject *meth_QNetworkProxy_isTransparentProxy(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_isTransparentProxy);
...
static PyObject *meth_QNetworkProxy_setCapabilities(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArgs,"BJ1",&sipSelf,sipType_QNetworkProxy,&sipCpp,sipType_QNetworkProxy_Capabilities,&a0,&a0State))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_setCapabilities);
...
static PyObject *meth_QNetworkProxy_capabilities(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipArgsParsed,sipName_QNetworkProxy,sipName_capabilities);

    return NULL;
}


extern "C" {static PyObject *slot_QNetworkProxy___ne__(PyObject *sipSelf,PyObject *sipArg);}
static PyObject *slot_QNetworkProxy___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipArgsParsed,sipArg,"1J9",sipType_QNetworkProxy,&a0))
        {
            bool sipRes;
...
extern "C" {static PyObject *slot_QNetworkProxy___eq__(PyObject *sipSelf,PyObject *sipArg);}
...
static void dealloc_QNetworkProxy(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QNetworkProxy(sipSelf->u.cppPtr,0);
    }
}


extern "C" {static void *init_QNetworkProxy(sipSimpleWrapper *, PyObject *, PyObject **, int *);}
static void *init_QNetworkProxy(sipSimpleWrapper *, PyObject *sipArgs, PyObject **, int *sipArgsParsed)
{
    ...
    if (!sipCpp)
    {
        ...
        if (sipParseArgs(sipArgsParsed,sipArgs,"E|J1tJ1J1",sipType_QNetworkProxy_ProxyType,&a0,sipType_QString,&a1,&a1State,&a2,sipType_QString,&a3,&a3State,sipType_QString,&a4,&a4State))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QNetworkProxy[] = {
    {sipName_CachingCapability, QNetworkProxy::CachingCapability, 51},
    {sipName_DefaultProxy, QNetworkProxy::DefaultProxy, 52},
    {sipName_FtpCachingProxy, QNetworkProxy::FtpCachingProxy, 52},
    {sipName_HostNameLookupCapability, QNetworkProxy::HostNameLookupCapability, 51},
    {sipName_HttpCachingProxy, QNetworkProxy::HttpCachingProxy, 52},
    {sipName_HttpProxy, QNetworkProxy::HttpProxy, 52},
    {sipName_ListeningCapability, QNetworkProxy::ListeningCapability, 51},
    {sipName_NoProxy, QNetworkProxy::NoProxy, 52},
    {sipName_Socks5Proxy, QNetworkProxy::Socks5Proxy, 52},
    {sipName_TunnelingCapability, QNetworkProxy::TunnelingCapability, 51},
    {sipName_UdpTunnelingCapability, QNetworkProxy::UdpTunnelingCapability, 51},
};
